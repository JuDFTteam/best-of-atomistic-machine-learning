...
- [GitHub](https://github.com/deepmind/alphafold) (👨‍💻 19 · 🔀 1.8K · 📦 6 · 📋 720 - 22% open · ⏱️ 10.08.2023):
...
🔗&nbsp;<b><a href="https://pages.nist.gov/jarvis_leaderboard/">JARVIS-Leaderboard</a></b> ( ⭐ 33)  - This project provides benchmark-performances for materials science applications including Artificial Intelligence.. <code>benchmarking</code>
...
- [GitHub](https://github.com/deepmodeling/dpdata) (👨‍💻 45 · 🔀 99 · 📦 100 · 📋 67 - 31% open · ⏱️ 04.05.2023):
	...
	```
- [PyPi](https://pypi.org/project/dpdata) (📥 2.9K / month):
	```
	pip install dpdata
	```
- [Conda](https://anaconda.org/deepmodeling/dpdata) (📥 470 · ⏱️ 16.06.2023):
	```
...
- [GitHub](https://github.com/ur-whitelab/exmol) (👨‍💻 7 · 🔀 37 · 📦 12 · 📋 66 - 13% open · ⏱️ 19.06.2023):
	...
	```
- [PyPi](https://pypi.org/project/exmol) (📥 660 / month):
	```
	pip install exmol
	```
</details>
...
- [GitHub](https://github.com/rdkit/rdkit) (👨‍💻 200 · 🔀 750 · 📥 1.4K · 📦 2 · 📋 2.9K - 29% open · ⏱️ 10.08.2023):
...
- [GitHub](https://github.com/materialsvirtuallab/maml) (👨‍💻 27 · 🔀 58 · 📦 4 · 📋 62 - 6% open · ⏱️ 10.08.2023):

	```
	git clone https://github.com/materialsvirtuallab/maml
	```
- [PyPi](https://pypi.org/project/maml) (📥 120 / month):
	```
	pip install maml
	```
</details>
<details><summary><b><a href="https://github.com/usnistgov/jarvis">JARVIS-Tools</a></b> (🥈22 ·  ⭐ 230) - JARVIS-Tools: an open-source software package for data-driven atomistic materials design. Publications:.. <code><a href="https://github.com/usnistgov/jarvis/blob/master/LICENSE.rst">Custom</a></code></summary>

- [GitHub](https://github.com/usnistgov/jarvis) (👨‍💻 15 · 🔀 100 · 📦 60 · 📋 79 - 45% open · ⏱️ 29.05.2023):

	```
	git clone https://github.com/usnistgov/jarvis
	```
- [PyPi](https://pypi.org/project/jarvis-tools) (📥 9.3K / month):
	```
...
- [GitHub](https://github.com/scikit-learn-contrib/scikit-matter) (👨‍💻 11 · 🔀 15 · 📦 5 · 📋 66 - 16% open · ⏱️ 08.08.2023):
	...
	```
- [PyPi](https://pypi.org/project/skmatter) (📥 790 / month):
	```
	pip install skmatter
	```
- [Conda](https://anaconda.org/conda-forge/skmatter) (📥 370 · ⏱️ 18.06.2023):
	```
...
- [GitHub](https://github.com/whitead/synspace) (👨‍💻 2 · 🔀 3 · 📦 4 · 📋 3 - 66% open · ⏱️ 15.04.2023):
	...
	```
- [PyPi](https://pypi.org/project/synspace) (📥 520 / month):
	```
...
- [PyPi](https://pypi.org/project/deepmd-kit) (📥 1K / month):
	...
	```
- [Conda](https://anaconda.org/deepmodeling/deepmd-kit) (📥 970 · ⏱️ 16.06.2023):
	```
...
- [GitHub](https://github.com/aiqm/torchani) (👨‍💻 16 · 🔀 110 · 📦 25 · 📋 150 - 11% open · ⏱️ 21.03.2023):
	...
	```
- [PyPi](https://pypi.org/project/torchani) (📥 2.5K / month):
	```
...
- [GitHub](https://github.com/materialsvirtuallab/megnet) (👨‍💻 13 · 🔀 140 · 📦 68 · 📋 74 - 22% open · ⏱️ 27.04.2023):
	...
	```
- [PyPi](https://pypi.org/project/megnet) (📥 910 / month):
	```
	pip install megnet
	```
</details>
...
- [GitHub](https://github.com/mir-group/nequip) (👨‍💻 8 · 🔀 88 · 📦 14 · 📋 59 - 18% open · ⏱️ 26.03.2023):
...
- [GitHub](https://github.com/stefanch/sGDML) (👨‍💻 7 · 🔀 34 · 📦 8 · 📋 16 - 31% open · ⏱️ 08.06.2023):
	...
	```
- [PyPi](https://pypi.org/project/sgdml) (📥 80 / month):
	```
	pip install sgdml
	```
</details>
...
- [GitHub](https://github.com/ACEsuit/mace) (👨‍💻 11 · 🔀 58 · 📋 53 - 33% open · ⏱️ 11.07.2023):
...
- [GitHub](https://github.com/Teoroo-CMC/CCS) (👨‍💻 8 · 🔀 8 · 📥 380 · 📋 13 - 61% open · ⏱️ 07.08.2023):
	...
	```
- [PyPi](https://pypi.org/project/ccs_fit) (📥 620 / month):
	```
	pip install ccs_fit
	```
</details>
...
- [GitHub](https://github.com/thorben-frank/mlff) (👨‍💻 2 · 🔀 5 · 📋 5 - 40% open · ⏱️ 07.08.2023):
...
- [GitHub](https://github.com/uf3/uf3) (👨‍💻 4 · 🔀 14 · 📋 27 - 37% open · ⏱️ 05.07.2023):
	...
	```
- [PyPi](https://pypi.org/project/uf3) (📥 16 / month):
	```
	pip install uf3
	```
</details>
...
- [GitHub](https://github.com/aimat-lab/NNsForMD) (👨‍💻 2 · 🔀 3 · ⏱️ 10.11.2022):
	...
	```
- [PyPi](https://pypi.org/project/pyNNsMD) (📥 33 / month):
	```
	pip install pyNNsMD
	```
</details>
...
- [GitHub](https://github.com/ziatdinovmax/gpax) (🔀 14 · ⏱️ 07.08.2023):
...
- [GitHub](https://github.com/lab-cosmo/sphericart) (👨‍💻 6 · 🔀 3 · 📦 1 · 📋 14 - 64% open · ⏱️ 18.07.2023):
	...
	```
- [PyPi](https://pypi.org/project/sphericart) (📥 89 / month):
	```
...
- [GitHub](https://github.com/jax-md/jax-md) (👨‍💻 28 · 🔀 160 · 📦 28 · 📋 130 - 44% open · ⏱️ 09.08.2023):
	...
	```
- [PyPi](https://pypi.org/project/jax-md) (📥 2.1K / month):
	```
	pip install jax-md
	```
</details>
...
<details><summary><b><a href="https://github.com/whitead/paper-qa">paper-qa</a></b> (🥇25 ·  ⭐ 2.9K · 🐣) - LLM Chain for answering questions from documents with citations. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/whitead/paper-qa) (👨‍💻 12 · 🔀 260 · 📦 22 · 📋 94 - 38% open · ⏱️ 08.08.2023):
...
- [GitHub](https://github.com/kjappelbaum/gptchem) (👨‍💻 2 · 🔀 27 · 📋 5 - 60% open · ⏱️ 22.06.2023):
	...
	```
- [PyPi](https://pypi.org/project/gptchem) (📥 78 / month):
	```
	pip install gptchem
	```
</details>
...
- [GitHub](https://github.com/whitead/nlcc) (👨‍💻 3 · 🔀 6 · ⏱️ 04.02.2023):
	...
	```
- [PyPi](https://pypi.org/project/nlcc) (📥 40 / month):
	```
	pip install nlcc
	```
</details>
...
- [PyPi](https://pypi.org/project/e3nn) (📥 15K / month):
	...
	pip install e3nn
	```
- [Conda](https://anaconda.org/conda-forge/e3nn) (📥 8.3K · ⏱️ 18.06.2023):
	```
...
- [GitHub](https://github.com/aimat-lab/gcnn_keras) (👨‍💻 7 · 🔀 24 · 📦 15 · 📋 77 - 6% open · ⏱️ 10.08.2023):
...
<details><summary><b><a href="https://github.com/materialsvirtuallab/matgl">MatGL (Materials Graph Library)</a></b> (🥈19 ·  ⭐ 96) - Graph deep learning library for materials. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/materialsvirtuallab/matgl) (👨‍💻 10 · 🔀 17 · 📦 2 · 📋 30 - 6% open · ⏱️ 10.08.2023):
...
- [GitHub](https://github.com/e3nn/e3nn-jax) (👨‍💻 4 · 🔀 13 · 📋 8 - 12% open · ⏱️ 06.08.2023):
...
- [GitHub](https://github.com/dptech-corp/Uni-Mol) (👨‍💻 7 · 🔀 70 · 📥 4.6K · 📋 90 - 28% open · ⏱️ 09.08.2023):
...
<details><summary><b><a href="https://github.com/hyllios/CGAT">CGAT</a></b> (🥉9 ·  ⭐ 11 · 💤) - Crystal graph attention neural networks for materials prediction. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/lanl/hippynn) (👨‍💻 11 · 🔀 18 · 📋 3 - 66% open · ⏱️ 05.08.2023):
...
<details><summary><b><a href="https://github.com/LLNL/graphite">graphite</a></b> (🥉7 ·  ⭐ 20) - A repository for implementing graph network models based on atomic structures. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/LLNL/graphite) (🔀 5 · ⏱️ 10.06.2023):
...
- [GitHub](https://github.com/atomicarchitects/equiformer) (👨‍💻 2 · 🔀 20 · 📋 10 - 40% open · ⏱️ 21.06.2023):
...
- [GitHub](https://github.com/SINGROUP/dscribe) (👨‍💻 18 · 🔀 78 · 📦 140 · 📋 85 - 9% open · ⏱️ 19.07.2023):
	...
	```
- [PyPi](https://pypi.org/project/dscribe) (📥 6.5K / month):
	```
	pip install dscribe
	```
...
- [GitHub](https://github.com/Luthaf/rascaline) (👨‍💻 10 · 🔀 11 · 📋 33 - 54% open · ⏱️ 28.07.2023):
...
- [GitHub](https://github.com/sissa-data-science/DADApy) (👨‍💻 15 · 🔀 8 · 📦 2 · 📋 24 - 37% open · ⏱️ 27.07.2023):
	...
	```
- [PyPi](https://pypi.org/project/dadapy) (📥 72 / month):
	```
	pip install dadapy
	```
</details>
...
- [GitHub](https://github.com/lab-cosmo/chemiscope) (👨‍💻 17 · 🔀 26 · 📥 130 · 📦 4 · 📋 110 - 37% open · ⏱️ 25.07.2023):
	...
	```
- [npm](https://www.npmjs.com/package/chemiscope) (📥 34 / month):
	```
...
- [GitHub](https://github.com/deepqmc/deepqmc) (👨‍💻 13 · 🔀 56 · 📦 1 · 📋 35 - 14% open · ⏱️ 08.08.2023):
	...
	```
- [PyPi](https://pypi.org/project/deepqmc) (📥 97 / month):
	```
	pip install deepqmc
	```
</details>
