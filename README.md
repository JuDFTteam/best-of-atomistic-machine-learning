...
- [GitHub](https://github.com/deepmodeling/dpgen) (👨‍💻 69 · 🔀 180 · 📥 1.9K · 📦 8 · 📋 330 - 16% open · ⏱️ 21.02.2025):
	...
	```
- [PyPi](https://pypi.org/project/dpgen) (📥 940 / month · 📦 2 · ⏱️ 21.02.2025):
	```
	pip install dpgen
	```
...
- [GitHub](https://github.com/Bin-Cao/Bgolearn) (👨‍💻 3 · 🔀 15 · 📥 46 · 📋 3 - 33% open · ⏱️ 10.03.2025):
	...
	```
- [PyPi](https://pypi.org/project/Bgolearn) (📥 800 / month · ⏱️ 23.02.2025):
	```
...
<details><summary><b><a href="https://thegardens.ai/">Garden</a></b> (🥇20 ·  ⭐ 26) - FAIR AI/ML Model Publishing Framework. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code>model-repository</code></summary>

- [GitHub](https://github.com/Garden-AI/garden) (👨‍💻 13 · 🔀 4 · 📦 6 · 📋 330 - 3% open · ⏱️ 28.03.2025):
...
- [GitHub](https://github.com/janosh/matbench-discovery) (👨‍💻 17 · 🔀 32 · 📦 4 · 📋 58 - 6% open · ⏱️ 10.04.2025):

	```
	git clone https://github.com/janosh/matbench-discovery
	```
- [PyPi](https://pypi.org/project/matbench-discovery) (📥 980 / month · ⏱️ 11.09.2024):
	```
...
- [GitHub](https://github.com/divelab/AIRS) (👨‍💻 32 · 🔀 66 · 📋 24 - 8% open · ⏱️ 20.03.2025):
...
- [GitHub](https://github.com/deepmodeling/deepmodeling-projects) (👨‍💻 4 · 🔀 2 · ⏱️ 04.04.2025):
...
- [GitHub](https://github.com/FAIR-Chem/fairchem) (👨‍💻 49 · 🔀 290 · 📋 310 - 7% open · ⏱️ 04.04.2025):
	...
	```
- [PyPi](https://pypi.org/project/fairchem-core) (📥 4.7K / month · 📦 8 · ⏱️ 29.03.2025):
	```
...
- [GitHub](https://github.com/materialsproject/MPContribs) (👨‍💻 27 · 🔀 24 · 📦 46 · 📋 110 - 26% open · ⏱️ 07.04.2025):

	```
	git clone https://github.com/materialsproject/MPContribs
	```
- [PyPi](https://pypi.org/project/mpcontribs-client) (📥 5.4K / month · 📦 3 · ⏱️ 28.02.2025):
	```
...
- [GitHub](https://github.com/jla-gardner/load-atoms) (👨‍💻 4 · 🔀 4 · 📦 6 · 📋 32 - 6% open · ⏱️ 16.12.2024):
	...
	```
- [PyPi](https://pypi.org/project/load-atoms) (📥 2.6K / month · 📦 2 · ⏱️ 13.12.2024):
	```
...
<details><summary><b><a href="https://matpes.ai/">MatPES</a></b> (🥈14 ·  ⭐ 29 · 🐣) - A foundational potential energy dataset for materials. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code> <a href="https://www.google.com/search?q=universal+interatomic+potential"><code>UIP</code></a> <code>ML-IAP</code></summary>
...
- [GitHub](https://github.com/materialsvirtuallab/matpes) (👨‍💻 2 · 🔀 4 · ⏱️ 27.03.2025):
	...
	```
- [PyPi](https://pypi.org/project/matpes) (📥 450 / month · ⏱️ 10.03.2025):
	```
	pip install matpes
	```
</details>
...
- [GitHub](https://github.com/mpds-io/mpds-api) (👨‍💻 5 · 🔀 5 · 📋 26 - 34% open · ⏱️ 16.01.2025):
	...
	```
- [PyPi](https://pypi.org/project/mpds_client) (📥 390 / month · ⏱️ 14.09.2020):
	```
...
- [GitHub](https://github.com/NRC-Mila/OBELiX) (👨‍💻 5 · 🔀 3 · ⏱️ 08.04.2025):

	```
	git clone https://github.com/NRC-Mila/OBELiX
	```
- [PyPi](https://pypi.org/project/obelix-data) (📥 370 / month · ⏱️ 17.03.2025):
	```
...
- [GitHub](https://github.com/deepmodeling/dpdata) (👨‍💻 63 · 🔀 140 · 📦 140 · 📋 120 - 28% open · ⏱️ 20.03.2025):
	...
	```
- [PyPi](https://pypi.org/project/dpdata) (📥 17K / month · 📦 40 · ⏱️ 20.03.2025):
	```
	pip install dpdata
	```
...
<details><summary><b><a href="https://github.com/metatensor/metatensor">Metatensor</a></b> (🥈22 ·  ⭐ 65) - Self-describing sparse tensor data format for atomistic machine learning and beyond. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code> <code>ML-IAP</code> <a href="https://en.wikipedia.org/wiki/Molecular_dynamics"><code>MD</code></a> <code>Rust</code> <code>C-lang</code> <code>C++</code> <code>Python</code></summary>

- [GitHub](https://github.com/metatensor/metatensor) (👨‍💻 29 · 🔀 20 · 📥 44K · 📦 13 · 📋 250 - 33% open · ⏱️ 10.04.2025):
...
- [GitHub](https://github.com/google-research/google-research) (👨‍💻 830 · 🔀 8K · 📋 1.8K - 81% open · ⏱️ 10.04.2025):
...
- [GitHub](https://github.com/lcmd-epfl/Q-stack) (👨‍💻 7 · 🔀 5 · 📋 34 - 29% open · ⏱️ 09.04.2025):

	```
	git clone https://github.com/lcmd-epfl/Q-stack
	```
</details>
<details><summary><b><a href="https://github.com/deepmodeling/dftio">dftio</a></b> (🥈8 ·  ⭐ 8) - dftio is to assist machine learning communities to transcript DFT output into a format that is easy to read or used by.. <code><a href="http://bit.ly/37RvQcA">LGPL-3.0</a></code> <code>data-structures</code> <code>workflows</code></summary>

- [GitHub](https://github.com/deepmodeling/dftio) (👨‍💻 4 · 🔀 4 · 📋 3 - 33% open · ⏱️ 08.04.2025):

	```
	git clone https://github.com/deepmodeling/dftio
	```
</details>
<details><summary><b><a href="https://github.com/QuantumLab-ZY/HamGNN">HamGNN</a></b> (🥈7 ·  ⭐ 91) - An E(3) equivariant Graph Neural Network for predicting electronic Hamiltonian matrix. <code><a href="http://bit.ly/2M0xdwT">GPL-3.0</a></code> <a href="https://en.wikipedia.org/wiki/Feature_learning"><code>rep-learn</code></a> <code>magnetism</code> <code>C-lang</code></summary>

- [GitHub](https://github.com/QuantumLab-ZY/HamGNN) (👨‍💻 2 · 🔀 16 · 📋 38 - 84% open · ⏱️ 08.04.2025):

	```
	git clone https://github.com/QuantumLab-ZY/HamGNN
	```
</details>
<details><summary><b><a href="https://github.com/AIforGreatGood/charge3net">ChargE3Net</a></b> (🥈7 ·  ⭐ 54) - Higher-order equivariant neural networks for charge density prediction in materials. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <a href="https://en.wikipedia.org/wiki/Feature_learning"><code>rep-learn</code></a></summary>
...
<details><summary><b><a href="https://github.com/kyonofx/scdp">scdp (scalable charge density prediction)</a></b> (🥈7 ·  ⭐ 30) - [NeurIPS 2024] source code for A Recipe for Charge Density Prediction. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <a href="https://en.wikipedia.org/wiki/Feature_learning"><code>rep-learn</code></a> <code>single-paper</code></summary>
...
- <b><a href="https://github.com/XanaduAI/GradDFT">Grad DFT</a></b> (🥈10 ·  ⭐ 86 · 💀) - GradDFT is a JAX-based library enabling the differentiable design and experimentation of exchange-correlation.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code>
...
<details><summary><b><a href="https://github.com/schwallergroup/ai4chem_course">AI4Chemistry course</a></b> (🥇13 ·  ⭐ 170) - EPFL AI for chemistry course, Spring 2023. https://schwallergroup.github.io/ai4chem_course. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code>chemistry</code></summary>

- [GitHub](https://github.com/schwallergroup/ai4chem_course) (👨‍💻 7 · 🔀 41 · 📋 4 - 25% open · ⏱️ 09.04.2025):
...
<details><summary><b><a href="https://matsciedu.github.io/DSM-CORE">DSM-CORE</a></b> (🥉6 ·  ⭐ 13 · 🐣) - Data Science for Materials - Collection of Open Educational Resources. <code>Unlicensed</code></summary>
...
- [GitHub](https://github.com/ur-whitelab/exmol) (👨‍💻 9 · 🔀 44 · 📦 25 · 📋 72 - 9% open · ⏱️ 06.04.2025):
	...
	```
- [PyPi](https://pypi.org/project/exmol) (📥 3.7K / month · 📦 3 · ⏱️ 21.03.2025):
	```
	pip install exmol
	```
</details>
...
<details><summary><b><a href="https://github.com/deepmodeling/DeePTB">DeePTB</a></b> (🥇15 ·  ⭐ 72) - DeePTB: A deep learning package for tight-binding approach with ab initio accuracy. <code><a href="http://bit.ly/37RvQcA">LGPL-3.0</a></code> <code>ML-DFT</code></summary>
...
- [GitHub](https://github.com/deepmodeling/DeePTB) (👨‍💻 11 · 🔀 17 · 📦 2 · 📋 45 - 33% open · ⏱️ 07.04.2025):
	...
	```
- [PyPi](https://pypi.org/project/dptb) (📥 320 / month · ⏱️ 15.08.2024):
	```
	pip install dptb
	```
</details>
...
- [GitHub](https://github.com/rdkit/rdkit) (👨‍💻 240 · 🔀 880 · 📦 3 · 📋 4K - 16% open · ⏱️ 10.04.2025):

	```
	git clone https://github.com/rdkit/rdkit
	```
- [PyPi](https://pypi.org/project/rdkit) (📥 620K / month · 📦 920 · ⏱️ 12.03.2025):
	```
	pip install rdkit
	```
...
- [GitHub](https://github.com/deepchem/deepchem) (👨‍💻 260 · 🔀 1.8K · 📦 560 · 📋 2K - 37% open · ⏱️ 19.03.2025):

	```
	git clone https://github.com/deepchem/deepchem
	```
- [PyPi](https://pypi.org/project/deepchem) (📥 57K / month · 📦 17 · ⏱️ 19.03.2025):
	```
...
<details><summary><b><a href="https://github.com/hackingmaterials/matminer">Matminer</a></b> (🥇27 ·  ⭐ 510) - Data mining for materials science. <code><a href="https://github.com/hackingmaterials/matminer/blob/main/LICENSE">Custom</a></code></summary>
...
- [GitHub](https://github.com/materialsvirtuallab/maml) (👨‍💻 34 · 🔀 84 · 📦 15 · 📋 75 - 16% open · ⏱️ 08.04.2025):

	```
	git clone https://github.com/materialsvirtuallab/maml
	```
- [PyPi](https://pypi.org/project/maml) (📥 1.5K / month · 📦 3 · ⏱️ 02.04.2025):
	```
	pip install maml
	```
</details>
...
- [GitHub](https://github.com/datamol-io/molfeat) (👨‍💻 19 · 🔀 22 · 📦 65 · 📋 54 - 20% open · ⏱️ 27.11.2024):
...
- [GitHub](https://github.com/uw-cmg/MAST-ML) (👨‍💻 19 · 🔀 61 · 📥 140 · 📦 47 · 📋 220 - 14% open · ⏱️ 18.03.2025):

	```
	git clone https://github.com/uw-cmg/MAST-ML
	```
</details>
<details><summary><b><a href="https://github.com/scikit-learn-contrib/scikit-matter">Scikit-Matter</a></b> (🥈18 ·  ⭐ 81 · 📈) - A collection of scikit-learn compatible utilities that implement methods born out of the materials science and.. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code> <code>scikit-learn</code></summary>

- [GitHub](https://github.com/scikit-learn-contrib/scikit-matter) (👨‍💻 15 · 🔀 21 · 📦 11 · 📋 73 - 21% open · ⏱️ 13.02.2025):
...
- [GitHub](https://github.com/qmlcode/qml) (👨‍💻 10 · 🔀 84 · 📋 59 - 64% open · ⏱️ 08.12.2024):
	...
	```
- [PyPi](https://pypi.org/project/qml) (📥 690 / month · ⏱️ 13.08.2018):
	```
	pip install qml
	```
</details>
...
- [GitHub](https://github.com/dralgroup/mlatom) (👨‍💻 5 · 🔀 11 · 📋 6 - 16% open · ⏱️ 26.03.2025):
	...
	```
- [PyPi](https://pypi.org/project/mlatom) (📥 1.7K / month · ⏱️ 26.03.2025):
	```
	pip install mlatom
	```
</details>
...
- [GitHub](https://github.com/GT4SD/gt4sd-core) (👨‍💻 20 · 🔀 73 · 📋 120 - 12% open · ⏱️ 19.02.2025):
	...
	git clone https://github.com/GT4SD/gt4sd-core
	```
- [PyPi](https://pypi.org/project/gt4sd) (📥 3.6K / month · ⏱️ 19.02.2025):
	```
	pip install gt4sd
	```
</details>
...
- [GitHub](https://github.com/xiaohang007/SLICES) (👨‍💻 1 · 🔀 43 · 📦 5 · 📋 16 - 25% open · ⏱️ 26.03.2025):

	```
	git clone https://github.com/xiaohang007/SLICES
	```
- [PyPi](https://pypi.org/project/slices) (📥 470 / month · 📦 1 · ⏱️ 01.03.2025):
	```
	pip install slices
	```
...
- [GitHub](https://github.com/hspark1212/MOFTransformer) (👨‍💻 2 · 🔀 14 · ⏱️ 20.06.2024):

	```
	git clone https://github.com/hspark1212/MOFTransformer
	```
- [PyPi](https://pypi.org/project/moftransformer) (📥 670 / month · 📦 1 · ⏱️ 20.06.2024):
	```
...
- [GitHub](https://github.com/RokasEl/simgen) (👨‍💻 4 · 🔀 3 · 📦 2 · 📋 4 - 25% open · ⏱️ 13.12.2024):
	...
	```
- [PyPi](https://pypi.org/project/simgen) (📥 80 / month · ⏱️ 13.12.2024):
	```
	pip install simgen
	```
</details>
...
- [GitHub](https://github.com/deepmodeling/deepmd-kit) (👨‍💻 75 · 🔀 540 · 📥 51K · 📦 28 · 📋 890 - 10% open · ⏱️ 02.03.2025):

	```
	git clone https://github.com/deepmodeling/deepmd-kit
	```
- [PyPi](https://pypi.org/project/deepmd-kit) (📥 5.8K / month · 📦 9 · ⏱️ 30.03.2025):
	```
...
- [GitHub](https://github.com/mir-group/nequip) (👨‍💻 13 · 🔀 150 · 📦 37 · 📋 99 - 25% open · ⏱️ 22.03.2025):

	```
	git clone https://github.com/mir-group/nequip
	```
- [PyPi](https://pypi.org/project/nequip) (📥 6K / month · 📦 11 · ⏱️ 23.03.2025):
	```
	pip install nequip
	```
...
- [GitHub](https://github.com/ACEsuit/mace) (👨‍💻 53 · 🔀 260 · 📋 370 - 21% open · ⏱️ 28.03.2025):
...
- [GitHub](https://github.com/torchmd/torchmd-net) (👨‍💻 17 · 🔀 83 · 📥 67 · 📋 130 - 33% open · ⏱️ 07.04.2025):

	```
	git clone https://github.com/torchmd/torchmd-net
	```
- [Conda](https://anaconda.org/conda-forge/torchmd-net) (📥 410K · ⏱️ 07.04.2025):
	```
	conda install -c conda-forge torchmd-net
	```
</details>
<details><summary><b><a href="https://github.com/materialsvirtuallab/matcalc">MatCalc</a></b> (🥇21 ·  ⭐ 80) - A python library for calculating materials properties from the PES. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code> <code>workflows</code> <code>benchmarking</code> <a href="https://www.google.com/search?q=universal+interatomic+potential"><code>UIP</code></a> <code>pretrained</code> <code>model-repository</code></summary>

- [GitHub](https://github.com/materialsvirtuallab/matcalc) (👨‍💻 15 · 🔀 20 · 📦 8 · 📋 10 - 30% open · ⏱️ 10.04.2025):

	```
	git clone https://github.com/materialsvirtuallab/matcalc
	```
- [PyPi](https://pypi.org/project/matcalc) (📥 3.1K / month · 📦 4 · ⏱️ 06.04.2025):
	```
	pip install matcalc
	```
</details>
<details><summary><b><a href="https://github.com/openkim/kliff">KLIFF</a></b> (🥈19 ·  ⭐ 35 · 📈) - KIM-based Learning-Integrated Fitting Framework for interatomic potentials. <code><a href="https://tldrlegal.com/search?q=LGPL-2.1">LGPL-2.1</a></code> <code>probabilistic</code> <code>workflows</code></summary>

- [GitHub](https://github.com/openkim/kliff) (👨‍💻 11 · 🔀 21 · 📦 4 · 📋 45 - 57% open · ⏱️ 10.04.2025):

	```
	git clone https://github.com/openkim/kliff
	```
- [PyPi](https://pypi.org/project/kliff) (📥 430 / month · ⏱️ 10.04.2025):
	```
	pip install kliff
	```
...
- [GitHub](https://github.com/metatensor/metatrain) (👨‍💻 15 · 🔀 8 · 📥 5 · 📦 3 · 📋 170 - 32% open · ⏱️ 09.04.2025):

	```
	git clone https://github.com/metatensor/metatrain
	```
- [PyPi](https://pypi.org/project/metatrain) (📥 1.2K / month · ⏱️ 29.03.2025):
	```
...
- [GitHub](https://github.com/apax-hub/apax) (👨‍💻 9 · 🔀 3 · 📦 4 · 📋 140 - 12% open · ⏱️ 08.04.2025):
...
- [GitHub](https://github.com/autoatml/autoplex) (👨‍💻 12 · 🔀 12 · 📦 2 · 📋 120 - 28% open · ⏱️ 07.04.2025):

	```
	git clone https://github.com/autoatml/autoplex
	```
- [PyPi](https://pypi.org/project/autoplex) (📥 440 / month · ⏱️ 05.02.2025):
	```
...
- [GitHub](https://github.com/jla-gardner/graph-pes) (👨‍💻 3 · 🔀 4 · 📦 2 · 📋 16 - 25% open · ⏱️ 10.04.2025):

	```
	git clone https://github.com/jla-gardner/graph-pes
	```
- [PyPi](https://pypi.org/project/graph-pes) (📥 1.6K / month · ⏱️ 10.04.2025):
	```
...
- [GitHub](https://github.com/basf/mlipx) (👨‍💻 4 · 🔀 6 · 📋 8 - 37% open · ⏱️ 07.04.2025):
...
- [GitHub](https://github.com/uf3/uf3) (👨‍💻 10 · 🔀 23 · 📦 2 · 📋 51 - 37% open · ⏱️ 04.10.2024):
	...
	```
- [PyPi](https://pypi.org/project/uf3) (📥 97 / month · ⏱️ 27.10.2023):
	```
	pip install uf3
	```
</details>
...
<details><summary><b><a href="https://cortner.github.io/ACEweb/software/">Pacemaker</a></b> (🥈12 ·  ⭐ 81) - Python package for fitting atomic cluster expansion (ACE) potentials. <code><a href="https://github.com/ICAMS/python-ace/blob/master/LICENSE.md">Custom</a></code></summary>
...
- [PyPi](https://pypi.org/project/calorine) (📥 2.4K / month · 📦 4 · ⏱️ 25.10.2024):
	```
...
- <b><a href="https://github.com/sirmarcel/glp">glp</a></b> (🥉4 ·  ⭐ 21 · 💀) - tools for graph-based machine-learning potentials in jax. <code><a href="http://bit.ly/34MBwT8">MIT</a></code>
...
<details><summary><b><a href="https://github.com/lamalab-org/chembench">ChemBench</a></b> (🥇20 ·  ⭐ 70) - How good are LLMs at chemistry?. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code>benchmarking</code> <a href="https://en.wikipedia.org/wiki/Multimodal_learning"><code>multimodal</code></a></summary>
...
- [GitHub](https://github.com/lamalab-org/chembench) (👨‍💻 14 · 🔀 8 · 📦 2 · 📋 320 - 14% open · ⏱️ 26.03.2025):
	...
	```
- [PyPi](https://pypi.org/project/chembench) (📥 7.8K / month · ⏱️ 27.02.2025):
	```
...
- [GitHub](https://github.com/ur-whitelab/chemcrow-public) (👨‍💻 3 · 🔀 100 · 📦 10 · 📋 23 - 39% open · ⏱️ 19.12.2024):
	...
	```
- [PyPi](https://pypi.org/project/chemcrow) (📥 740 / month · ⏱️ 27.03.2024):
	```
...
- [GitHub](https://github.com/Yeonghun1675/ChatMOF) (👨‍💻 1 · 🔀 16 · 📦 3 · 📋 7 - 14% open · ⏱️ 04.03.2025):
	...
	```
- [PyPi](https://pypi.org/project/chatmof) (📥 670 / month · ⏱️ 01.07.2024):
	```
	pip install chatmof
	```
</details>
<details><summary><b><a href="https://github.com/chiang-yuan/llamp">LLaMP</a></b> (🥉8 ·  ⭐ 79) - A web app and Python API for multi-modal RAG framework to ground LLMs on high-fidelity materials informatics. An.. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code> <a href="https://en.wikipedia.org/wiki/Multimodal_learning"><code>multimodal</code></a> <a href="https://en.wikipedia.org/wiki/Retrieval-augmented_generation"><code>RAG</code></a> <a href="https://www.psik2022.net/program/symposia#h.p_hM6hJbQD9dex"><code>materials-discovery</code></a> <code>pretrained</code> <code>JavaScript</code> <code>Python</code></summary>
...
<details><summary><b><a href="https://github.com/OSU-NLP-Group/LLM4Chem">LLM4Chem</a></b> (🥉6 ·  ⭐ 82 · 💤) - Official code repo for the paper LlaSMol: Advancing Large Language Models for Chemistry with a Large-Scale,.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <a href="https://en.wikipedia.org/wiki/Cheminformatics"><code>cheminformatics</code></a> <code>datasets</code></summary>
...
- [GitHub](https://github.com/CFN-softbio/SciBot) (👨‍💻 1 · 🔀 10 · ⏱️ 03.09.2024):
...
- [GitHub](https://github.com/WMD-group/SMACT) (👨‍💻 46 · 🔀 26 · 📦 49 · 📋 59 - 10% open · ⏱️ 07.04.2025):
	...
	```
- [PyPi](https://pypi.org/project/smact) (📥 5.7K / month · 📦 5 · ⏱️ 02.04.2025):
	```
	pip install smact
	```
- [Conda](https://anaconda.org/conda-forge/smact) (📥 4.3K · ⏱️ 25.03.2025):
	```
...
- [GitHub](https://github.com/microsoft/mattergen) (👨‍💻 9 · 🔀 190 · 📋 84 - 3% open · ⏱️ 27.03.2025):
...
- [GitHub](https://github.com/CompRhys/aviary) (👨‍💻 6 · 🔀 13 · 📋 33 - 12% open · ⏱️ 07.04.2025):
...
- [PyPi](https://pypi.org/project/aalto-boss) (📥 1.3K / month · ⏱️ 13.11.2024):
	```
...
- [GitHub](https://github.com/google-deepmind/kfac-jax) (👨‍💻 18 · 🔀 24 · 📦 11 · 📋 21 - 47% open · ⏱️ 07.04.2025):
...
- [GitHub](https://github.com/NVIDIA/cuEquivariance) (👨‍💻 4 · 🔀 11 · 📋 21 - 28% open · ⏱️ 09.04.2025):
	...
	```
- [PyPi](https://pypi.org/project/cuequivariance) (📥 8.2K / month · 📦 2 · ⏱️ 07.03.2025):
	```
	pip install cuequivariance
	```
- [Conda](https://anaconda.org/conda-forge/cuequivariance) (📥 1.2K · ⏱️ 25.03.2025):
	```
...
- [GitHub](https://github.com/lab-cosmo/sphericart) (👨‍💻 11 · 🔀 14 · 📥 280 · 📋 44 - 47% open · ⏱️ 03.04.2025):
...
<details><summary><b><a href="https://github.com/PASSIONLab/OpenEquivariance">OpenEquivariance</a></b> (🥉10 ·  ⭐ 47) - OpenEquivariance: a fast, open-source GPU JIT kernel generator for the Clebsch-Gordon Tensor Product. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code> <a href="https://en.wikipedia.org/wiki/Feature_learning"><code>rep-learn</code></a></summary>

- [GitHub](https://github.com/PASSIONLab/OpenEquivariance) (👨‍💻 3 · 🔀 3 · 📋 8 - 12% open · ⏱️ 10.04.2025):
...
- [GitHub](https://github.com/brucefan1983/GPUMD) (👨‍💻 45 · 🔀 130 · 📋 210 - 8% open · ⏱️ 10.04.2025):
...
- [GitHub](https://github.com/luigibonati/mlcolvar) (👨‍💻 8 · 🔀 26 · 📦 5 · 📋 77 - 20% open · ⏱️ 19.02.2025):
	...
	```
- [PyPi](https://pypi.org/project/mlcolvar) (📥 370 / month · ⏱️ 19.02.2025):
	```
...
- [GitHub](https://github.com/openmm/openmm-torch) (👨‍💻 9 · 🔀 28 · 📋 96 - 29% open · ⏱️ 20.02.2025):

	```
	git clone https://github.com/openmm/openmm-torch
	```
- [Conda](https://anaconda.org/conda-forge/openmm-torch) (📥 760K · ⏱️ 25.03.2025):
	```
...
- [GitHub](https://github.com/FitSNAP/FitSNAP) (👨‍💻 25 · 🔀 56 · 📥 13 · 📋 77 - 20% open · ⏱️ 09.04.2025):
...
<details><summary><b><a href="https://github.com/Radical-AI/torch-sim">TorchSim</a></b> (🥈16 ·  ⭐ 170 · 🐣) - Torch-native, batchable, atomistic simulation. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <a href="https://en.wikipedia.org/wiki/High-throughput_computing"><code>HTC</code></a> <a href="https://www.google.com/search?q=universal+interatomic+potential"><code>UIP</code></a> <code>ML-IAP</code> <a href="https://www.psik2022.net/program/symposia#h.p_hM6hJbQD9dex"><code>structure-optimization</code></a></summary>

- [GitHub](https://github.com/Radical-AI/torch-sim) (👨‍💻 6 · 🔀 17 · 📋 43 - 51% open · ⏱️ 08.04.2025):

	```
	git clone https://github.com/Radical-AI/torch-sim
	```
- [PyPi](https://pypi.org/project/torch-sim-atomistic) (📥 180 / month · ⏱️ 03.04.2025):
	```
...
- [GitHub](https://github.com/cdk/cdk) (👨‍💻 170 · 🔀 170 · 📥 25K · 📋 310 - 9% open · ⏱️ 02.04.2025):
...
- [GitHub](https://github.com/SINGROUP/dscribe) (👨‍💻 18 · 🔀 91 · 📦 240 · 📋 100 - 8% open · ⏱️ 28.05.2024):
	...
	```
- [PyPi](https://pypi.org/project/dscribe) (📥 37K / month · 📦 35 · ⏱️ 28.05.2024):
	```
	pip install dscribe
	```
...
<details><summary><b><a href="https://github.com/ppdebreuck/modnet">MODNet</a></b> (🥇16 ·  ⭐ 91) - MODNet: a framework for machine learning materials properties. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code>pretrained</code> <code>small-data</code> <a href="https://en.wikipedia.org/wiki/Transfer_learning"><code>transfer-learning</code></a></summary>
...
- [GitHub](https://github.com/WMD-group/ElementEmbeddings) (👨‍💻 6 · 🔀 4 · 📦 5 · 📋 22 - 22% open · ⏱️ 09.01.2025):
	...
	```
- [PyPi](https://pypi.org/project/ElementEmbeddings) (📥 3.2K / month · ⏱️ 18.09.2024):
	```
...
- [GitHub](https://github.com/PhasesResearchLab/pySIPFENN) (👨‍💻 4 · 🔀 4 · 📥 110 · 📦 7 · 📋 6 - 66% open · ⏱️ 06.03.2025):
	...
	```
- [PyPi](https://pypi.org/project/pysipfenn) (📥 660 / month · ⏱️ 06.03.2025):
	```
	pip install pysipfenn
	```
- [Conda](https://anaconda.org/conda-forge/pysipfenn) (📥 13K · ⏱️ 25.03.2025):
	```
...
- [GitHub](https://github.com/hachmannlab/chemml) (👨‍💻 15 · 🔀 32 · 📥 14 · 📦 7 · 📋 13 - 53% open · ⏱️ 20.01.2025):
	...
	```
- [PyPi](https://pypi.org/project/chemml) (📥 820 / month · 📦 2 · ⏱️ 08.10.2023):
	```
	pip install chemml
	```
</details>
...
- [GitHub](https://github.com/rouyang2017/SISSO) (👨‍💻 3 · 🔀 84 · 📋 77 - 23% open · ⏱️ 21.03.2025):
...
- [GitHub](https://github.com/WMD-group/PDynA) (👨‍💻 4 · 🔀 3 · 📦 2 · ⏱️ 11.10.2024):
	...
	```
- [PyPi](https://pypi.org/project/pdyna) (📥 100 / month · ⏱️ 23.09.2024):
	```
	pip install pdyna
	```
</details>
...
- [GitHub](https://github.com/pyg-team/pytorch_geometric) (👨‍💻 540 · 🔀 3.8K · 📦 8.7K · 📋 3.9K - 30% open · ⏱️ 08.04.2025):
...
- [GitHub](https://github.com/e3nn/e3nn) (👨‍💻 36 · 🔀 150 · 📦 440 · 📋 170 - 18% open · ⏱️ 09.04.2025):

	```
	git clone https://github.com/e3nn/e3nn
	```
- [PyPi](https://pypi.org/project/e3nn) (📥 140K / month · 📦 46 · ⏱️ 22.03.2025):
	```
	pip install e3nn
	```
...
- [GitHub](https://github.com/materialsvirtuallab/matgl) (👨‍💻 17 · 🔀 72 · 📦 72 · 📋 120 - 5% open · ⏱️ 07.04.2025):

	```
	git clone https://github.com/materialsvirtuallab/matgl
	```
- [PyPi](https://pypi.org/project/matgl) (📥 33K / month · 📦 26 · ⏱️ 07.04.2025):
	```
	pip install matgl
	```
- [Docker Hub](https://hub.docker.com/r/materialsvirtuallab/matgl) (📥 57 · ⭐ 1 · ⏱️ 08.04.2025):
	```
...
- [GitHub](https://github.com/e3nn/e3nn-jax) (👨‍💻 8 · 🔀 20 · 📦 57 · 📋 25 - 12% open · ⏱️ 23.01.2025):
	...
	```
- [PyPi](https://pypi.org/project/e3nn-jax) (📥 5.3K / month · 📦 13 · ⏱️ 14.08.2024):
	```
...
- [GitHub](https://github.com/deepmodeling/Uni-Mol) (👨‍💻 19 · 🔀 140 · 📥 18K · 📋 200 - 46% open · ⏱️ 07.04.2025):
...
- [GitHub](https://github.com/QUVA-Lab/escnn) (👨‍💻 10 · 🔀 51 · 📋 77 - 49% open · ⏱️ 31.10.2024):
	...
	```
- [PyPi](https://pypi.org/project/escnn) (📥 4.6K / month · 📦 6 · ⏱️ 01.04.2022):
	```
	pip install escnn
	```
</details>
...
- [GitHub](https://github.com/Ramprasad-Group/polygnn) (👨‍💻 4 · 🔀 8 · ⏱️ 05.02.2025):

	```
	git clone https://github.com/Ramprasad-Group/polygnn
	```
</details>
<details><summary><b><a href="https://github.com/lamm-mit/Graph-Aware-Transformers">Graph-Aware-Transformers</a></b> (🥉6 ·  ⭐ 57 · 🐣) - Graph-Aware Attention for Adaptive Dynamics in Transformers. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code> <a href="https://en.wikipedia.org/wiki/Transformer_(machine_learning_model)"><code>transformer</code></a> <code>graph-data</code> <code>pretrained</code> <code>single-paper</code></summary>
...
- [GitHub](https://github.com/MDIL-SNU/SevenNet) (👨‍💻 16 · 🔀 25 · 📥 930 · 📦 13 · 📋 52 - 19% open · ⏱️ 09.04.2025):
...
<details><summary><b><a href="https://github.com/orbital-materials/orb-models">Orb Models</a></b> (🥈20 ·  ⭐ 390) - ORB forcefield models from Orbital Materials. <code><a href="https://github.com/orbital-materials/orb-models/blob/main/LICENSE">Custom</a></code> <code>ML-IAP</code> <code>pretrained</code></summary>

- [GitHub](https://github.com/orbital-materials/orb-models) (👨‍💻 11 · 🔀 50 · 📦 11 · 📋 34 - 14% open · ⏱️ 10.04.2025):

	```
	git clone https://github.com/orbital-materials/orb-models
	```
- [PyPi](https://pypi.org/project/orb-models) (📥 5K / month · 📦 9 · ⏱️ 10.04.2025):
	```
...
- [GitHub](https://github.com/CederGroupHub/chgnet) (👨‍💻 10 · 🔀 77 · 📦 54 · 📋 70 - 7% open · ⏱️ 24.03.2025):

	```
	git clone https://github.com/CederGroupHub/chgnet
	```
- [PyPi](https://pypi.org/project/chgnet) (📥 37K / month · 📦 21 · ⏱️ 16.09.2024):
	```
	pip install chgnet
	```
</details>
...
- [GitHub](https://github.com/microsoft/mattersim) (👨‍💻 14 · 🔀 41 · 📥 19 · 📋 25 - 32% open · ⏱️ 02.04.2025):

	```
	git clone https://github.com/microsoft/mattersim
	```
- [PyPi](https://pypi.org/project/mattersim) (📥 26K / month · 📦 2 · ⏱️ 21.02.2025):
	```
...
- [GitHub](https://github.com/ACEsuit/mace-foundations) (👨‍💻 2 · 🔀 250 · 📥 100K · 📋 16 - 18% open · ⏱️ 28.03.2025):

	```
	git clone https://github.com/ACEsuit/mace-foundations
	```
- [PyPi](https://pypi.org/project/mace-torch) (📥 53K / month · 📦 30 · ⏱️ 16.03.2025):
	```
...
- [GitHub](https://github.com/janosh/ffonons) (👨‍💻 2 · 🔀 1 · 📦 2 · ⏱️ 08.12.2024):
	...
	```
- [PyPi](https://pypi.org/project/ffonons) (📥 56 / month · ⏱️ 10.01.2024):
	```
	pip install ffonons
	```
</details>
...
- [GitHub](https://github.com/sparks-baird/mat_discover) (👨‍💻 5 · 🔀 9 · 📋 40 - 72% open · ⏱️ 20.08.2024):
	...
	```
- [PyPi](https://pypi.org/project/mat_discover) (📥 810 / month · ⏱️ 23.06.2023):
	```
...
- [GitHub](https://github.com/janosh/pymatviz) (👨‍💻 11 · 🔀 23 · 📦 21 · 📋 59 - 20% open · ⏱️ 08.04.2025):

	```
	git clone https://github.com/janosh/pymatviz
	```
- [PyPi](https://pypi.org/project/pymatviz) (📥 9.2K / month · 📦 6 · ⏱️ 28.01.2025):
	```
...
- [GitHub](https://github.com/materialsproject/crystaltoolkit) (👨‍💻 31 · 🔀 60 · 📦 42 · 📋 120 - 49% open · ⏱️ 05.03.2025):
	...
	```
- [PyPi](https://pypi.org/project/crystal-toolkit) (📥 2.8K / month · 📦 10 · ⏱️ 25.01.2025):
	```
...
- [GitHub](https://github.com/janosh/elementari) (👨‍💻 2 · 🔀 15 · 📦 4 · 📋 7 - 28% open · ⏱️ 05.04.2025):

	```
	git clone https://github.com/janosh/elementari
	```
- [npm](https://www.npmjs.com/package/elementari) (📥 710 / month · 📦 2 · ⏱️ 05.04.2025):
	```
...
- [GitHub](https://github.com/google-deepmind/ferminet) (👨‍💻 21 · 🔀 140 · 📋 65 - 3% open · ⏱️ 17.03.2025):
...
- [GitHub](https://github.com/mdsunivie/deeperwin) (👨‍💻 9 · 🔀 8 · 📥 15 · 📦 2 · ⏱️ 19.12.2024):
	...
	```
- [PyPi](https://pypi.org/project/deeperwin) (📥 160 / month · ⏱️ 14.12.2021):
	```
