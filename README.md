...
- [GitHub](https://github.com/deepmodeling/dpgen) (👨‍💻 76 · 🔀 190 · 📥 2.1K · 📦 8 · 📋 370 - 17% open · ⏱️ 12.07.2026):
	...
	```
- [PyPi](https://pypi.org/project/dpgen) (📥 760 / month · 📦 2 · ⏱️ 12.05.2026):
	```
	pip install dpgen
	```
...
- [GitHub](https://github.com/Bin-Cao/Bgolearn) (👨‍💻 4 · 🔀 21 · 📥 86 · ⏱️ 10.08.2026):
...
- [GitHub](https://github.com/deepmodeling/dpgen2) (👨‍💻 19 · 🔀 36 · 📦 6 · 📋 63 - 52% open · ⏱️ 12.07.2026):
...
- <b><a href="https://github.com/ulissigroup/finetuna">Finetuna</a></b> (🥉10 ·  ⭐ 71 · 💀) - Active Learning for Machine Learning Potentials. <code><a href="http://bit.ly/34MBwT8">MIT</a></code>
...
<details><summary><b><a href="https://github.com/janosh/matbench-discovery">MatBench Discovery</a></b> (🥇24 ·  ⭐ 250) - An evaluation framework for machine learning models simulating high-throughput materials discovery. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code>datasets</code> <code>benchmarking</code> <code>model-repository</code></summary>

- [GitHub](https://github.com/janosh/matbench-discovery) (👨‍💻 35 · 🔀 65 · 📥 26K · 📦 8 · 📋 78 - 3% open · ⏱️ 12.08.2026):

	```
	git clone https://github.com/janosh/matbench-discovery
	```
- [PyPi](https://pypi.org/project/matbench-discovery) (📥 9.2K / month · 📦 2 · ⏱️ 11.09.2024):
	```
...
- [GitHub](https://github.com/Garden-AI/garden) (👨‍💻 14 · 🔀 5 · 📦 6 · 📋 380 - 3% open · ⏱️ 18.03.2026):
	...
	```
- [PyPi](https://pypi.org/project/garden-ai) (📥 1.7K / month · ⏱️ 18.03.2026):
	```
...
- [GitHub](https://github.com/facebookresearch/fairchem) (👨‍💻 72 · 🔀 480 · 📋 590 - 1% open · ⏱️ 11.08.2026):

	```
	git clone https://github.com/FAIR-Chem/fairchem
	```
- [PyPi](https://pypi.org/project/fairchem-core) (📥 100K / month · 📦 48 · ⏱️ 08.06.2026):
	```
...
- [GitHub](https://github.com/materialsproject/MPContribs) (👨‍💻 32 · 🔀 27 · 📦 60 · 📋 120 - 30% open · ⏱️ 14.07.2026):
	...
	```
- [PyPi](https://pypi.org/project/mpcontribs-client) (📥 8.8K / month · 📦 7 · ⏱️ 09.02.2026):
	```
...
- [GitHub](https://github.com/Materials-Consortia/optimade-python-tools) (👨‍💻 37 · 🔀 54 · 📋 480 - 18% open · ⏱️ 06.08.2026):
	...
	```
- [PyPi](https://pypi.org/project/optimade) (📥 25K / month · 📦 4 · ⏱️ 21.06.2026):
	```
...
- [GitHub](https://github.com/jla-gardner/load-atoms) (👨‍💻 5 · 🔀 5 · 📦 8 · 📋 35 - 14% open · ⏱️ 25.11.2025):
	...
	```
- [PyPi](https://pypi.org/project/load-atoms) (📥 2K / month · 📦 3 · ⏱️ 25.11.2025):
	```
...
- [GitHub](https://github.com/materialyzeai/matpes) (👨‍💻 3 · 🔀 5 · 📋 10 - 20% open · ⏱️ 01.07.2026):
	...
	```
- [PyPi](https://pypi.org/project/matpes) (📥 190 / month · 📦 2 · ⏱️ 10.03.2025):
	```
	pip install matpes
	```
</details>
...
- [GitHub](https://github.com/deepmodeling/AIS-Square) (👨‍💻 8 · 🔀 9 · 📋 6 - 83% open · ⏱️ 11.08.2026):
...
- [GitHub](https://github.com/NRC-Mila/OBELiX) (👨‍💻 6 · 🔀 9 · 📋 2 - 50% open · ⏱️ 27.11.2025):
	...
	```
- [PyPi](https://pypi.org/project/obelix-data) (📥 99 / month · ⏱️ 16.05.2025):
	```
	pip install obelix-data
	```
</details>
<details><summary><b><a href="https://github.com/Ramprasad-Group/polyVERSE">polyVERSE</a></b> (🥉9 ·  ⭐ 41) - polyVERSE is a comprehensive repository of informatics-ready datasets curated by the Ramprasad Group. <code><a href="https://github.com/Ramprasad-Group/polyVERSE?tab=License-1-ov-file">Custom</a></code> <a href="https://en.wikipedia.org/wiki/Soft_matter"><code>soft-matter</code></a></summary>
...
- [GitHub](https://github.com/deepmodeling/dpdata) (👨‍💻 72 · 🔀 160 · 📦 160 · 📋 190 - 24% open · ⏱️ 02.08.2026):
	...
	```
- [PyPi](https://pypi.org/project/dpdata) (📥 91K / month · 📦 44 · ⏱️ 07.05.2026):
	```
	pip install dpdata
	```
...
- [GitHub](https://github.com/metatensor/metatensor) (👨‍💻 37 · 🔀 28 · 📥 59K · 📦 16 · 📋 270 - 20% open · ⏱️ 12.08.2026):
...
- [GitHub](https://github.com/dmlc/dlpack) (👨‍💻 36 · 🔀 160 · 📋 88 - 27% open · ⏱️ 11.08.2026):
...
- [GitHub](https://github.com/google-research/google-research) (👨‍💻 880 · 🔀 8.4K · 📋 2.3K - 84% open · ⏱️ 13.08.2026):
...
- [GitHub](https://github.com/mir-group/CiderPress) (👨‍💻 3 · 🔀 3 · ⏱️ 07.08.2026):
	...
	```
- [PyPi](https://pypi.org/project/ciderpress) (📥 22 / month · ⏱️ 13.03.2025):
	```
...
- [GitHub](https://github.com/QuantumLab-ZY/HamGNN) (👨‍💻 8 · 🔀 48 · 📋 85 - 83% open · ⏱️ 27.07.2026):
...
<details><summary><b><a href="https://github.com/StefanoSanvitoGroup/MLdensity">MLDensity</a></b> (🥈8 ·  ⭐ 8) - Linear Jacobi-Legendre expansion of the charge density for machine learning-accelerated electronic structure.. <code>Unlicensed</code></summary>

- [GitHub](https://github.com/StefanoSanvitoGroup/MLdensity) (👨‍💻 3 · ⏱️ 11.08.2026):
...
- [GitHub](https://github.com/lab-cosmo/atomistic-cookbook) (👨‍💻 23 · 🔀 11 · 📋 35 - 31% open · ⏱️ 13.08.2026):
...
- <b><a href="https://github.com/WardLT/applied-ai-for-materials">Applied AI for Materials</a></b> (🥉6 ·  ⭐ 85 · 💀) - Course materials for Applied AI for Materials Science and Engineering. <code>Unlicensed</code>
...
- <b><a href="https://github.com/muhrin/e3psi">e3psi</a></b> (🥉4 ·  ⭐ 7 · 💀) - Equivariant machine learning library for learning from electronic structures. <code><a href="http://bit.ly/37RvQcA">LGPL-3.0</a></code>
</details>
<br>
...
- [GitHub](https://github.com/rdkit/rdkit) (👨‍💻 280 · 🔀 1K · 📦 3 · 📋 3.8K - 1% open · ⏱️ 13.08.2026):

	```
	git clone https://github.com/rdkit/rdkit
	```
- [PyPi](https://pypi.org/project/rdkit) (📥 5.9M / month · 📦 2K · ⏱️ 03.08.2026):
	```
	pip install rdkit
	```
...
- [GitHub](https://github.com/deepchem/deepchem) (👨‍💻 260 · 🔀 2.3K · 📦 670 · 📋 2.5K - 46% open · ⏱️ 10.08.2026):

	```
	git clone https://github.com/deepchem/deepchem
	```
- [PyPi](https://pypi.org/project/deepchem) (📥 45K / month · 📦 32 · ⏱️ 10.08.2026):
	```
...
<details><summary><b><a href="https://github.com/materialyzeai/maml">MAML</a></b> (🥈21 ·  ⭐ 460 · 📉) - Python for Materials Machine Learning, Materials Descriptors, Machine Learning Force Fields, Deep Learning, etc. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>
...
- [GitHub](https://github.com/dralgroup/mlatom) (👨‍💻 7 · 🔀 21 · 📋 8 - 37% open · ⏱️ 13.08.2026):

	```
	git clone https://github.com/dralgroup/mlatom
	```
- [PyPi](https://pypi.org/project/mlatom) (📥 2.1K / month · 📦 3 · ⏱️ 13.08.2026):
	```
	pip install mlatom
	```
</details>
...
- [GitHub](https://github.com/scikit-learn-contrib/scikit-matter) (👨‍💻 19 · 🔀 25 · 📥 24 · 📋 84 - 26% open · ⏱️ 03.08.2026):
	...
	```
- [PyPi](https://pypi.org/project/skmatter) (📥 13K / month · 📦 7 · ⏱️ 06.01.2026):
	```
	pip install skmatter
	```
- [Conda](https://anaconda.org/conda-forge/skmatter) (📥 8.6K · ⏱️ 08.01.2026):
	```
...
- <b><a href="https://github.com/deepchem/jaxchem">JAXChem</a></b> (🥉7 ·  ⭐ 85 · 💀) - JAXChem is a JAX-based deep learning library for complex and versatile chemical modeling. <code><a href="http://bit.ly/34MBwT8">MIT</a></code>
...
- [GitHub](https://github.com/GT4SD/gt4sd-core) (👨‍💻 20 · 🔀 81 · 📋 110 - 1% open · ⏱️ 31.07.2026):
	...
	git clone https://github.com/GT4SD/gt4sd-core
	```
- [PyPi](https://pypi.org/project/gt4sd) (⏱️ 31.07.2026):
	```
	pip install gt4sd
	```
</details>
...
- [GitHub](https://github.com/hspark1212/MOFTransformer) (👨‍💻 2 · 🔀 21 · 📦 8 · 📋 48 - 4% open · ⏱️ 23.05.2026):
	...
	```
- [PyPi](https://pypi.org/project/moftransformer) (📥 640 / month · 📦 1 · ⏱️ 20.06.2024):
	```
...
- [GitHub](https://github.com/xiaohang007/SLICES) (👨‍💻 2 · 🔀 57 · 📦 7 · 📋 17 - 23% open · ⏱️ 03.03.2026):
	...
	```
- [PyPi](https://pypi.org/project/slices) (📥 80 / month · 📦 1 · ⏱️ 14.10.2025):
	```
	pip install slices
	```
...
- [GitHub](https://github.com/deepmodeling/deepmd-kit) (👨‍💻 89 · 🔀 620 · 📥 76K · 📦 60 · 📋 1.2K - 13% open · ⏱️ 13.08.2026):

	```
	git clone https://github.com/deepmodeling/deepmd-kit
	```
- [PyPi](https://pypi.org/project/deepmd-kit) (📥 29K / month · 📦 21 · ⏱️ 06.06.2026):
	```
...
- [Conda](https://anaconda.org/deepmodeling/deepmd-kit) (📥 4.1K · ⏱️ 25.03.2025):
	...
	```
- [Docker Hub](https://hub.docker.com/r/deepmodeling/deepmd-kit) (📥 6.3K · ⭐ 1 · ⏱️ 07.06.2026):
	```
...
- [GitHub](https://github.com/mir-group/nequip) (👨‍💻 45 · 🔀 210 · 📦 56 · 📋 130 - 3% open · ⏱️ 19.07.2026):
...
- [PyPi](https://pypi.org/project/nequip) (📥 11K / month · 📦 25 · ⏱️ 16.07.2026):
	...
	pip install nequip
	```
- [Conda](https://anaconda.org/conda-forge/nequip) (📥 30K · ⏱️ 16.07.2026):
	```
...
- [GitHub](https://github.com/aiqm/torchani) (👨‍💻 23 · 🔀 140 · 📦 79 · 📋 180 - 4% open · ⏱️ 20.07.2026):
	...
	```
- [PyPi](https://pypi.org/project/torchani) (📥 8.3K / month · 📦 24 · ⏱️ 20.07.2026):
	```
...
- [GitHub](https://github.com/materialyzeai/matcalc) (👨‍💻 23 · 🔀 36 · 📦 27 · 📋 47 - 8% open · ⏱️ 11.08.2026):
...
- [GitHub](https://github.com/ACEsuit/mace) (👨‍💻 77 · 🔀 440 · 📋 660 - 28% open · ⏱️ 07.08.2026):

	```
	git clone https://github.com/ACEsuit/mace
	```
</details>
<details><summary><b><a href="https://github.com/metatensor/metatrain">Metatrain</a></b> (🥇24 ·  ⭐ 77 · 📉) - Train, fine-tune, and manipulate machine learning models for atomistic systems. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code> <code>workflows</code> <code>benchmarking</code> <a href="https://en.wikipedia.org/wiki/Feature_engineering"><code>rep-eng</code></a> <a href="https://en.wikipedia.org/wiki/Feature_learning"><code>rep-learn</code></a></summary>

- [GitHub](https://github.com/metatensor/metatrain) (👨‍💻 40 · 🔀 41 · 📥 110 · 📦 17 · 📋 320 - 33% open · ⏱️ 11.08.2026):

	```
	git clone https://github.com/metatensor/metatrain
	```
- [PyPi](https://pypi.org/project/metatrain) (📥 8.8K / month · 📦 6 · ⏱️ 11.08.2026):
	```
...
- [GitHub](https://github.com/torchmd/torchmd-net) (👨‍💻 20 · 🔀 97 · 📥 230 · 📋 120 - 25% open · ⏱️ 13.07.2026):
	...
	```
- [Conda](https://anaconda.org/conda-forge/torchmd-net) (📥 960K · ⏱️ 18.03.2026):
	```
...
- [GitHub](https://github.com/stfc/janus-core) (👨‍💻 11 · 🔀 18 · 📥 260 · 📦 16 · 📋 320 - 16% open · ⏱️ 07.08.2026):
	...
	```
- [PyPi](https://pypi.org/project/janus-core) (📥 5K / month · 📦 7 · ⏱️ 18.07.2026):
	```
...
- [GitHub](https://github.com/openkim/kliff) (👨‍💻 14 · 🔀 21 · 📦 4 · 📋 56 - 41% open · ⏱️ 28.02.2026):
	...
	```
- [PyPi](https://pypi.org/project/kliff) (📥 68 / month · ⏱️ 11.04.2025):
	```
	pip install kliff
	```
...
- [GitHub](https://github.com/autoatml/autoplex) (👨‍💻 16 · 🔀 25 · 📦 2 · 📋 150 - 23% open · ⏱️ 13.08.2026):

	```
	git clone https://github.com/autoatml/autoplex
	```
- [PyPi](https://pypi.org/project/autoplex) (📥 51 / month · ⏱️ 14.05.2026):
	```
...
- [GitHub](https://github.com/apax-hub/apax) (👨‍💻 11 · 🔀 7 · 📦 7 · 📋 180 - 17% open · ⏱️ 01.06.2026):
	...
	```
- [PyPi](https://pypi.org/project/apax) (📥 71 / month · 📦 2 · ⏱️ 18.03.2026):
	```
	pip install apax
	```
</details>
...
- [GitHub](https://github.com/basf/mlipx) (👨‍💻 5 · 🔀 8 · 📦 7 · 📋 18 - 33% open · ⏱️ 16.10.2025):
	...
	```
- [PyPi](https://pypi.org/project/mlipx) (📥 3.4K / month · 📦 4 · ⏱️ 09.06.2025):
	```
	pip install mlipx
	```
</details>
...
- [GitHub](https://github.com/stfc/aiida-mlip) (👨‍💻 9 · 🔀 13 · 📥 53 · 📦 3 · 📋 160 - 43% open · ⏱️ 28.07.2026):
	...
	```
- [PyPi](https://pypi.org/project/aiida-mlip) (📥 210 / month · ⏱️ 17.11.2025):
	```
...
- [PyPi](https://pypi.org/project/calorine) (📥 15K / month · 📦 10 · ⏱️ 06.07.2026):
	```
...
- [GitHub](https://github.com/ICAMS/python-ace) (👨‍💻 7 · 🔀 27 · 📋 73 - 43% open · ⏱️ 05.06.2026):
	...
	```
- [PyPi](https://pypi.org/project/python-ace) (📥 18 / month · ⏱️ 24.10.2022):
	```
...
- [GitHub](https://github.com/ACEsuit/mace-jax) (👨‍💻 9 · 🔀 23 · 📋 11 - 45% open · ⏱️ 10.08.2026):
...
<details><summary><b><a href="https://github.com/mcaroba/turbogap">TurboGAP</a></b> (🥉11 ·  ⭐ 21 · 📈) - The TurboGAP code. <code><a href="https://github.com/mcaroba/turbogap/blob/master/LICENSE.md">Custom</a></code> <code>Fortran</code></summary>

- [GitHub](https://github.com/mcaroba/turbogap) (👨‍💻 11 · 🔀 14 · 📋 12 - 25% open · ⏱️ 12.08.2026):
...
<details><summary><b><a href="https://github.com/lanl/ALF">ALF</a></b> (🥉9 ·  ⭐ 45) - An open-source active learning framework for training machine-learned interatomic potentials. <code><a href="https://github.com/lanl/ALF/blob/main/LICENSE">Custom</a></code> <a href="https://en.wikipedia.org/wiki/Active_learning_(machine_learning)"><code>active-learning</code></a></summary>

- [GitHub](https://github.com/lanl/ALF) (👨‍💻 9 · 🔀 16 · ⏱️ 13.08.2026):
...
- [GitHub](https://github.com/atomicarchitects/equiformer_v2) (👨‍💻 2 · 🔀 49 · 📋 27 - 66% open · ⏱️ 10.04.2026):
...
- [GitHub](https://github.com/RowleyGroup/MLXDM) (👨‍💻 8 · 🔀 2 · ⏱️ 11.08.2026):
...
<details><summary><b><a href="https://futurehouse.gitbook.io/futurehouse-cookbook">paper-qa</a></b> (🥇19 ·  ⭐ 9K · 📈) - LLM Chain for answering questions from docs. <code>Unlicensed</code> <a href="https://en.wikipedia.org/wiki/Large_language_model#Agency"><code>ai-agent</code></a></summary>
...
- [GitHub](https://github.com/lamalab-org/chembench) (👨‍💻 15 · 🔀 19 · 📦 3 · 📋 340 - 16% open · ⏱️ 11.09.2025):
	...
	```
- [PyPi](https://pypi.org/project/chembench) (📥 920 / month · ⏱️ 27.02.2025):
	```
...
- [GitHub](https://github.com/WMD-group/SMACT) (👨‍💻 51 · 🔀 32 · 📦 83 · ⏱️ 09.08.2026):

	```
	git clone https://github.com/WMD-group/SMACT
	```
- [PyPi](https://pypi.org/project/smact) (📥 21K / month · 📦 14 · ⏱️ 03.03.2026):
	```
	pip install smact
	```
...
- [PyPi](https://pypi.org/project/aalto-boss) (📥 220 / month · ⏱️ 31.05.2026):
	```
...
- [GitHub](https://github.com/NVIDIA/cuEquivariance) (👨‍💻 14 · 🔀 39 · 📋 90 - 25% open · ⏱️ 10.08.2026):
...
- [GitHub](https://github.com/PASSIONLab/OpenEquivariance) (👨‍💻 6 · 🔀 15 · 📦 8 · 📋 39 - 5% open · ⏱️ 09.08.2026):

	```
	git clone https://github.com/PASSIONLab/OpenEquivariance
	```
- [PyPi](https://pypi.org/project/openequivariance) (📥 32K / month · 📦 4 · ⏱️ 14.06.2026):
	```
...
- [GitHub](https://github.com/lab-cosmo/sphericart) (👨‍💻 15 · 🔀 17 · 📥 1.3K · 📦 11 · 📋 52 - 17% open · ⏱️ 09.07.2026):
	...
	```
- [PyPi](https://pypi.org/project/sphericart) (📥 7.3K / month · 📦 2 · ⏱️ 09.07.2026):
	```
...
- [GitHub](https://github.com/risi-kondor/cnine) (👨‍💻 8 · 🔀 4 · 📋 2 - 50% open · ⏱️ 13.08.2026):
...
<details><summary><b><a href="https://github.com/jax-md/jax-md">JAX-MD</a></b> (🥇28 ·  ⭐ 1.5K) - Differentiable, Hardware Accelerated, Molecular Dynamics. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>
...
- [GitHub](https://github.com/TorchSim/torch-sim) (👨‍💻 38 · 🔀 100 · 📋 170 - 10% open · ⏱️ 01.08.2026):
	...
	```
- [PyPi](https://pypi.org/project/torch-sim-atomistic) (📥 28K / month · 📦 34 · ⏱️ 27.07.2026):
	```
...
- [GitHub](https://github.com/brucefan1983/GPUMD) (👨‍💻 64 · 🔀 200 · 📋 280 - 7% open · ⏱️ 13.08.2026):
...
- [GitHub](https://github.com/luigibonati/mlcolvar) (👨‍💻 15 · 🔀 35 · 📦 13 · 📋 120 - 9% open · ⏱️ 14.07.2026):
	...
	```
- [PyPi](https://pypi.org/project/mlcolvar) (📥 720 / month · 📦 4 · ⏱️ 03.02.2026):
	```
...
- [GitHub](https://github.com/openmm/openmm-ml) (👨‍💻 12 · 🔀 47 · 📦 2 · 📋 81 - 32% open · ⏱️ 10.08.2026):

	```
	git clone https://github.com/openmm/openmm-ml
	```
- [Conda](https://anaconda.org/conda-forge/openmm-ml) (📥 66K · ⏱️ 08.06.2026):
	```
...
- [PyPi](https://pypi.org/project/dscribe) (📥 60K / month · 📦 63 · ⏱️ 27.09.2025):
	...
	pip install dscribe
	```
- [Conda](https://anaconda.org/conda-forge/dscribe) (📥 310K · ⏱️ 09.08.2026):
	```
...
- [GitHub](https://github.com/hachmannlab/chemml) (👨‍💻 17 · 🔀 34 · 📥 14 · 📦 8 · 📋 16 - 43% open · ⏱️ 28.07.2026):

	```
	git clone https://github.com/hachmannlab/chemml
	```
- [PyPi](https://pypi.org/project/chemml) (📥 140 / month · 📦 2 · ⏱️ 08.10.2023):
	```
	pip install chemml
	```
</details>
...
- [GitHub](https://github.com/WMD-group/ElementEmbeddings) (👨‍💻 10 · 🔀 5 · 📦 6 · ⏱️ 09.08.2026):
	...
	```
- [PyPi](https://pypi.org/project/ElementEmbeddings) (📥 720 / month · 📦 2 · ⏱️ 14.07.2026):
	```
	pip install ElementEmbeddings
	```
- [Conda](https://anaconda.org/conda-forge/elementembeddings) (📥 4.8K · ⏱️ 15.07.2026):
	```
...
- [GitHub](https://github.com/metatensor/featomic) (👨‍💻 21 · 🔀 19 · 📥 1K · 📦 2 · 📋 88 - 47% open · ⏱️ 22.07.2026):
...
- [GitHub](https://github.com/PhasesResearchLab/pySIPFENN) (👨‍💻 5 · 🔀 6 · 📥 120 · 📦 7 · 📋 10 - 70% open · ⏱️ 18.07.2026):
	...
	```
- [PyPi](https://pypi.org/project/pysipfenn) (📥 300 / month · ⏱️ 18.07.2026):
	```
...
- [GitHub](https://github.com/capoe/benchml) (👨‍💻 9 · 🔀 6 · 📋 13 - 23% open · ⏱️ 28.10.2025):
	...
	```
- [PyPi](https://pypi.org/project/benchml) (📥 34 / month · ⏱️ 14.07.2022):
	```
	pip install benchml
	```
</details>
...
- [GitHub](https://github.com/libAtoms/soap_turbo) (👨‍💻 4 · 🔀 10 · 📋 8 - 62% open · ⏱️ 29.05.2026):
...
- <b><a href="https://github.com/Kaaiian/CBFV">CBFV</a></b> (🥈12 ·  ⭐ 32 · 💀) - Tool to quickly create a composition-based feature vector. <code>Unlicensed</code>
...
- [PyPi](https://pypi.org/project/e3nn) (📥 460K / month · 📦 74 · ⏱️ 13.02.2026):
	...
	pip install e3nn
	```
- [Conda](https://anaconda.org/conda-forge/e3nn) (📥 80K · ⏱️ 29.04.2026):
	```
...
- [GitHub](https://github.com/materialyzeai/matgl) (👨‍💻 27 · 🔀 120 · 📦 100 · 📋 160 - 2% open · ⏱️ 06.08.2026):

	```
	git clone https://github.com/materialsvirtuallab/matgl
	```
- [PyPi](https://pypi.org/project/matgl) (📥 35K / month · 📦 35 · ⏱️ 02.07.2026):
	```
	pip install matgl
	```
...
- [GitHub](https://github.com/e3nn/e3nn-jax) (👨‍💻 8 · 🔀 23 · 📦 97 · 📋 26 - 15% open · ⏱️ 01.04.2026):
	...
	```
- [PyPi](https://pypi.org/project/e3nn-jax) (📥 71K / month · 📦 35 · ⏱️ 01.04.2026):
	```
...
- [GitHub](https://github.com/usnistgov/alignn) (👨‍💻 8 · 🔀 110 · 📋 87 - 67% open · ⏱️ 25.08.2025):
	...
	```
- [PyPi](https://pypi.org/project/alignn) (📥 6.7K / month · 📦 16 · ⏱️ 07.08.2026):
	```
	pip install alignn
	```
</details>
...
- <b><a href="https://github.com/omron-sinicx/crystalformer">Crystalformer</a></b> (🥉6 ·  ⭐ 30 · 💀) - The official code respository for Crystalformer: Infinitely Connected Attention for Periodic Structure Encoding (ICLR.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <a href="https://en.wikipedia.org/wiki/Transformer_(machine_learning_model)"><code>transformer</code></a> <code>single-paper</code>
...
- [PyPi](https://pypi.org/project/deepmd-kit) (📥 29K / month · 📦 21 · ⏱️ 06.06.2026):
	...
	pip install deepmd-kit
	```
- [Conda](https://anaconda.org/conda-forge/deepmd-kit) (📥 3.1M · ⏱️ 11.08.2026):
	```
...
- [GitHub](https://github.com/ACEsuit/mace-foundations) (👨‍💻 5 · 🔀 420 · 📥 550K · 📋 43 - 18% open · ⏱️ 12.07.2026):
...
- [GitHub](https://github.com/MDIL-SNU/SevenNet) (👨‍💻 22 · 🔀 57 · 📥 37K · 📋 96 - 18% open · ⏱️ 22.07.2026):

	```
	git clone https://github.com/MDIL-SNU/SevenNet
	```
- [PyPi](https://pypi.org/project/sevenn) (📥 25K / month · 📦 28 · ⏱️ 19.06.2026):
	```
	pip install sevenn
	```
</details>
...
- [GitHub](https://github.com/orbital-materials/orb-models) (👨‍💻 16 · 🔀 88 · 📦 41 · 📋 80 - 8% open · ⏱️ 07.08.2026):

	```
	git clone https://github.com/orbital-materials/orb-models
	```
- [PyPi](https://pypi.org/project/orb-models) (📥 16K / month · 📦 38 · ⏱️ 26.05.2026):
	```
...
- [GitHub](https://github.com/lab-cosmo/upet) (👨‍💻 17 · 🔀 24 · 📥 110 · 📦 12 · 📋 23 - 4% open · ⏱️ 01.07.2026):
...
- [GitHub](https://github.com/ICAMS/grace-tensorpotential) (👨‍💻 5 · 🔀 17 · 📦 17 · 📋 20 - 70% open · ⏱️ 13.07.2026):
...
<details><summary><b><a href="https://github.com/sissa-data-science/DADApy">DADApy</a></b> (🥇21 ·  ⭐ 150 · 📉) - Distance-based Analysis of DAta-manifolds in python. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>
...
- [GitHub](https://github.com/materialsproject/crystaltoolkit) (👨‍💻 39 · 🔀 67 · 📦 43 · 📋 150 - 45% open · ⏱️ 12.08.2026):

	```
	git clone https://github.com/materialsproject/crystaltoolkit
	```
- [PyPi](https://pypi.org/project/crystal-toolkit) (📥 33K / month · 📦 13 · ⏱️ 12.08.2026):
	```
	pip install crystal-toolkit
	```
</details>
<details><summary><b><a href="https://github.com/janosh/pymatviz">pymatviz</a></b> (🥈24 ·  ⭐ 330) - A toolkit for visualizations in materials informatics. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code>general-tool</code> <code>probabilistic</code></summary>

- [GitHub](https://github.com/janosh/pymatviz) (👨‍💻 14 · 🔀 42 · 📥 23K · 📦 37 · ⏱️ 31.07.2026):

	```
	git clone https://github.com/janosh/pymatviz
	```
- [PyPi](https://pypi.org/project/pymatviz) (📥 33K / month · 📦 10 · ⏱️ 07.06.2026):
	```
...
- [GitHub](https://github.com/janosh/matterviz) (👨‍💻 10 · 🔀 44 · 📥 12K · 📦 8 · ⏱️ 13.08.2026):
...
- [GitHub](https://github.com/lab-cosmo/chemiscope) (👨‍💻 27 · 🔀 43 · 📥 750 · 📦 6 · 📋 170 - 9% open · ⏱️ 08.08.2026):
	...
	```
- [npm](https://www.npmjs.com/package/chemiscope) (📥 74 / month · 📦 3 · ⏱️ 15.03.2023):
	```
...
- [GitHub](https://github.com/zincware/ZnDraw) (👨‍💻 17 · 🔀 5 · 📦 16 · 📋 400 - 23% open · ⏱️ 27.05.2026):
	...
	```
- [PyPi](https://pypi.org/project/zndraw) (📥 4.2K / month · 📦 5 · ⏱️ 01.04.2026):
	```
	pip install zndraw
	```
</details>
...
- [GitHub](https://github.com/usnistgov/atomvision) (👨‍💻 4 · 🔀 17 · 📦 4 · 📋 9 - 55% open · ⏱️ 25.08.2025):
	...
	```
- [PyPi](https://pypi.org/project/atomvision) (📥 99 / month · ⏱️ 08.05.2023):
	```
...
- [GitHub](https://github.com/deepqmc/deepqmc) (👨‍💻 16 · 🔀 63 · 📥 4 · 📦 3 · 📋 65 - 1% open · ⏱️ 10.08.2026):

	```
	git clone https://github.com/deepqmc/deepqmc
	```
- [PyPi](https://pypi.org/project/deepqmc) (📥 260 / month · ⏱️ 20.07.2026):
	```
	pip install deepqmc
	```
</details>
...
- [GitHub](https://github.com/bytedance/jaqmc) (👨‍💻 8 · 🔀 25 · ⏱️ 12.08.2026):
