...
- [GitHub](https://github.com/deepmodeling/dpgen) (👨‍💻 73 · 🔀 180 · 📥 2.1K · 📦 8 · 📋 340 - 13% open · ⏱️ 01.03.2026):
	...
	```
- [PyPi](https://pypi.org/project/dpgen) (📥 500 / month · 📦 2 · ⏱️ 07.08.2025):
	```
	pip install dpgen
	```
...
- [GitHub](https://github.com/Bin-Cao/Bgolearn) (👨‍💻 4 · 🔀 18 · 📥 71 · ⏱️ 16.03.2026):
	...
	```
- [PyPi](https://pypi.org/project/Bgolearn) (📥 200 / month · ⏱️ 13.01.2026):
	```
...
- [GitHub](https://github.com/janosh/matbench-discovery) (👨‍💻 28 · 🔀 54 · 📦 5 · 📋 72 - 4% open · ⏱️ 13.03.2026):

	```
	git clone https://github.com/janosh/matbench-discovery
	```
- [PyPi](https://pypi.org/project/matbench-discovery) (📥 2.5K / month · 📦 2 · ⏱️ 11.09.2024):
	```
...
- [GitHub](https://github.com/Garden-AI/garden) (👨‍💻 14 · 🔀 4 · 📦 6 · 📋 380 - 3% open · ⏱️ 18.03.2026):
	...
	```
- [PyPi](https://pypi.org/project/garden-ai) (📥 310 / month · ⏱️ 18.03.2026):
	```
...
- [GitHub](https://github.com/facebookresearch/fairchem) (👨‍💻 67 · 🔀 450 · 📋 560 - 3% open · ⏱️ 18.03.2026):

	```
	git clone https://github.com/FAIR-Chem/fairchem
	```
- [PyPi](https://pypi.org/project/fairchem-core) (📥 120K / month · 📦 41 · ⏱️ 17.03.2026):
	```
...
- [GitHub](https://github.com/materialsproject/MPContribs) (👨‍💻 29 · 🔀 27 · 📦 58 · 📋 120 - 30% open · ⏱️ 26.02.2026):
	...
	```
- [PyPi](https://pypi.org/project/mpcontribs-client) (📥 6.6K / month · 📦 7 · ⏱️ 09.02.2026):
	```
...
- [GitHub](https://github.com/jla-gardner/load-atoms) (👨‍💻 5 · 🔀 5 · 📦 8 · 📋 35 - 14% open · ⏱️ 25.11.2025):
	...
	```
- [PyPi](https://pypi.org/project/load-atoms) (📥 170K / month · 📦 3 · ⏱️ 25.11.2025):
	```
...
- [GitHub](https://github.com/NRC-Mila/OBELiX) (👨‍💻 6 · 🔀 9 · 📋 2 - 50% open · ⏱️ 27.11.2025):
	...
	```
- [PyPi](https://pypi.org/project/obelix-data) (📥 38 / month · ⏱️ 16.05.2025):
	```
...
- [GitHub](https://github.com/deepmodeling/dpdata) (👨‍💻 67 · 🔀 160 · 📦 160 · 📋 160 - 32% open · ⏱️ 18.03.2026):

	```
	git clone https://github.com/deepmodeling/dpdata
	```
- [PyPi](https://pypi.org/project/dpdata) (📥 74K / month · 📦 44 · ⏱️ 28.02.2026):
	```
	pip install dpdata
	```
...
<details><summary><b><a href="https://github.com/metatensor/metatensor">Metatensor</a></b> (🥈22 ·  ⭐ 97) - Self-describing sparse tensor data format for atomistic machine learning and beyond. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code> <code>ML-IAP</code> <a href="https://en.wikipedia.org/wiki/Molecular_dynamics"><code>MD</code></a> <code>Rust</code> <code>C-lang</code> <code>C++</code> <code>Python</code></summary>

- [GitHub](https://github.com/metatensor/metatensor) (👨‍💻 36 · 🔀 26 · 📥 54K · 📦 14 · 📋 270 - 26% open · ⏱️ 07.03.2026):
...
- [GitHub](https://github.com/materialsproject/pyrho) (👨‍💻 10 · 🔀 10 · 📦 33 · 📋 10 - 70% open · ⏱️ 13.10.2025):
	...
	```
- [PyPi](https://pypi.org/project/mp-pyrho) (📥 180K / month · 📦 5 · ⏱️ 13.10.2025):
	```
...
- [GitHub](https://github.com/google-research/google-research) (👨‍💻 860 · 🔀 8.3K · 📋 2.1K - 83% open · ⏱️ 18.03.2026):
...
- [GitHub](https://github.com/andreagrisafi/SALTED) (👨‍💻 24 · 🔀 6 · 📋 11 - 27% open · ⏱️ 10.03.2026):
...
- [GitHub](https://github.com/QuantumLab-ZY/HamGNN) (👨‍💻 7 · 🔀 43 · 📋 78 - 83% open · ⏱️ 19.03.2026):
...
- [GitHub](https://github.com/schwallergroup/ai4chem_course) (👨‍💻 10 · 🔀 59 · 📋 4 - 25% open · ⏱️ 16.03.2026):
...
<details><summary><b><a href="https://github.com/lab-cosmo/atomistic-cookbook">COSMO Software Cookbook</a></b> (🥇12 ·  ⭐ 44) - A collection of simulation recipes for the atomic-scale modeling of materials and molecules. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/lab-cosmo/atomistic-cookbook) (👨‍💻 20 · 🔀 8 · 📋 32 - 31% open · ⏱️ 19.03.2026):
...
<details><summary><b><a href="https://github.com/ur-whitelab/exmol">exmol</a></b> (🥇17 ·  ⭐ 350 · 💤) - Explainer for black box models that predict molecule properties. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/ur-whitelab/exmol) (👨‍💻 9 · 🔀 46 · 📋 71 - 7% open · ⏱️ 08.05.2025):

	```
	git clone https://github.com/ur-whitelab/exmol
	```
- [PyPi](https://pypi.org/project/exmol) (📥 3.7K / month):
	```
	pip install exmol
	```
</details>
...
- [GitHub](https://github.com/deepmodeling/DeePTB) (👨‍💻 15 · 🔀 27 · 📦 4 · 📋 64 - 37% open · ⏱️ 19.03.2026):

	```
	git clone https://github.com/deepmodeling/DeePTB
	```
- [PyPi](https://pypi.org/project/dptb) (📥 120 / month · 📦 2 · ⏱️ 07.05.2025):
	```
	pip install dptb
	```
</details>
...
- <b><a href="https://github.com/masashitsubaki/QuantumDeepField_molecule">QDF for molecule</a></b> (🥈9 ·  ⭐ 230 · 💀) - Quantum deep field: data-driven wave function, electron density generation, and energy prediction and extrapolation.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code>
...
- [GitHub](https://github.com/rdkit/rdkit) (👨‍💻 270 · 🔀 960 · 📦 3 · 📋 4.3K - 15% open · ⏱️ 19.03.2026):

	```
	git clone https://github.com/rdkit/rdkit
	```
- [PyPi](https://pypi.org/project/rdkit) (📥 3.4M / month · 📦 1.5K · ⏱️ 02.03.2026):
	```
	pip install rdkit
	```
...
- [GitHub](https://github.com/deepchem/deepchem) (👨‍💻 260 · 🔀 2.1K · 📦 660 · 📋 2.2K - 41% open · ⏱️ 20.02.2026):

	```
	git clone https://github.com/deepchem/deepchem
	```
- [PyPi](https://pypi.org/project/deepchem) (📥 34K / month · 📦 24 · ⏱️ 20.02.2026):
	```
...
- [GitHub](https://github.com/hackingmaterials/matminer) (👨‍💻 57 · 🔀 210 · 📦 470 · 📋 230 - 12% open · ⏱️ 10.02.2026):
	...
	```
- [PyPi](https://pypi.org/project/matminer) (📥 650K / month · 📦 86 · ⏱️ 22.01.2026):
	```
...
- [GitHub](https://github.com/libAtoms/QUIP) (👨‍💻 86 · 🔀 130 · 📥 860 · 📦 46 · 📋 490 - 23% open · ⏱️ 30.01.2026):
	...
	```
- [PyPi](https://pypi.org/project/quippy-ase) (📥 3.9K / month · 📦 9 · ⏱️ 30.01.2026):
	```
...
- [GitHub](https://github.com/materialyzeai/maml) (👨‍💻 39 · 🔀 93 · 📦 17 · 📋 76 - 14% open · ⏱️ 14.02.2026):
	...
	```
- [PyPi](https://pypi.org/project/maml) (📥 880 / month · 📦 3 · ⏱️ 02.04.2025):
	```
	pip install maml
	```
</details>
...
- [GitHub](https://github.com/datamol-io/molfeat) (👨‍💻 19 · 🔀 27 · 📦 73 · 📋 58 - 24% open · ⏱️ 27.05.2025):

	```
	git clone https://github.com/datamol-io/molfeat
	```
- [PyPi](https://pypi.org/project/molfeat) (📥 6.6K / month):
	```
	pip install molfeat
	```
...
- [GitHub](https://github.com/scikit-learn-contrib/scikit-matter) (👨‍💻 20 · 🔀 25 · 📥 19 · 📋 84 - 26% open · ⏱️ 19.01.2026):
	...
	```
- [PyPi](https://pypi.org/project/skmatter) (📥 3.1K / month · 📦 7 · ⏱️ 06.01.2026):
	```
...
- [GitHub](https://github.com/pycroscopy/atomai) (👨‍💻 6 · 🔀 41 · 📦 13 · 📋 20 - 55% open · ⏱️ 23.06.2025):
	...
	```
- [PyPi](https://pypi.org/project/atomai) (📥 760 / month · 📦 1 · ⏱️ 23.06.2025):
	```
	pip install atomai
	```
</details>
...
- [GitHub](https://github.com/dralgroup/mlatom) (👨‍💻 6 · 🔀 17 · 📋 8 - 37% open · ⏱️ 09.03.2026):
	...
	```
- [PyPi](https://pypi.org/project/mlatom) (📥 820 / month · ⏱️ 09.03.2026):
	```
	pip install mlatom
	```
</details>
...
- [PyPi](https://pypi.org/project/slices) (📥 240 / month · 📦 1 · ⏱️ 14.10.2025):
	...
	pip install slices
	```
- [Docker Hub](https://hub.docker.com/r/xiaohang07/slices) (📥 730 · ⭐ 1 · ⏱️ 14.10.2025):
	```
...
- [GitHub](https://github.com/whitead/synspace) (👨‍💻 2 · 🔀 4 · 📦 36 · 📋 4 - 50% open · ⏱️ 24.04.2025):
	...
	```
- [PyPi](https://pypi.org/project/synspace) (📥 3.9K / month · 📦 4 · ⏱️ 24.04.2025):
	```
...
- <b><a href="https://github.com/ehoogeboom/e3_diffusion_for_molecules">EDM</a></b> (🥈10 ·  ⭐ 550 · 💀) - E(3) Equivariant Diffusion Model for Molecule Generation in 3D. <code><a href="http://bit.ly/34MBwT8">MIT</a></code>
...
- [GitHub](https://github.com/mir-group/nequip) (👨‍💻 39 · 🔀 200 · 📦 44 · 📋 120 - 4% open · ⏱️ 02.03.2026):

	```
	git clone https://github.com/mir-group/nequip
	```
- [PyPi](https://pypi.org/project/nequip) (📥 180K / month · 📦 15 · ⏱️ 04.03.2026):
	```
	pip install nequip
	```
...
- [GitHub](https://github.com/deepmodeling/deepmd-kit) (👨‍💻 84 · 🔀 600 · 📥 68K · 📦 46 · 📋 1K - 13% open · ⏱️ 19.03.2026):
...
- [GitHub](https://github.com/materialyzeai/matcalc) (👨‍💻 23 · 🔀 34 · 📦 22 · 📋 36 - 19% open · ⏱️ 17.03.2026):

	```
	git clone https://github.com/materialsvirtuallab/matcalc
	```
- [PyPi](https://pypi.org/project/matcalc) (📥 1.9K / month · 📦 10 · ⏱️ 09.12.2025):
	```
	pip install matcalc
	```
</details>
...
- [GitHub](https://github.com/metatensor/metatrain) (👨‍💻 34 · 🔀 23 · 📥 73 · 📦 13 · 📋 300 - 31% open · ⏱️ 18.03.2026):
...
- [GitHub](https://github.com/torchmd/torchmd-net) (👨‍💻 19 · 🔀 97 · 📥 180 · 📋 120 - 25% open · ⏱️ 17.03.2026):

	```
	git clone https://github.com/torchmd/torchmd-net
	```
- [Conda](https://anaconda.org/conda-forge/torchmd-net) (📥 770K · ⏱️ 18.03.2026):
	```
...
- [GitHub](https://github.com/stfc/janus-core) (👨‍💻 11 · 🔀 17 · 📥 240 · 📦 14 · 📋 310 - 16% open · ⏱️ 12.03.2026):
	...
	```
- [PyPi](https://pypi.org/project/janus-core) (📥 3.1K / month · 📦 6 · ⏱️ 10.03.2026):
	```
...
- [GitHub](https://github.com/apax-hub/apax) (👨‍💻 11 · 🔀 7 · 📦 7 · 📋 180 - 17% open · ⏱️ 18.03.2026):

	```
	git clone https://github.com/apax-hub/apax
	```
- [PyPi](https://pypi.org/project/apax) (📥 400 / month · 📦 2 · ⏱️ 18.03.2026):
	```
	pip install apax
	```
</details>
...
- [GitHub](https://github.com/openkim/kliff) (👨‍💻 14 · 🔀 22 · 📦 4 · 📋 57 - 42% open · ⏱️ 28.02.2026):
	...
	```
- [PyPi](https://pypi.org/project/kliff) (📥 75 / month · ⏱️ 11.04.2025):
	```
	pip install kliff
	```
...
- [GitHub](https://github.com/stefanch/sGDML) (👨‍💻 8 · 🔀 42 · 📦 13 · 📋 22 - 50% open · ⏱️ 13.06.2025):
	...
	```
- [PyPi](https://pypi.org/project/sgdml) (📥 270 / month · 📦 2 · ⏱️ 13.06.2025):
	```
	pip install sgdml
	```
</details>
...
- [GitHub](https://github.com/autoatml/autoplex) (👨‍💻 14 · 🔀 22 · 📦 2 · 📋 140 - 25% open · ⏱️ 09.03.2026):
	...
	```
- [PyPi](https://pypi.org/project/autoplex) (📥 57 / month · ⏱️ 14.11.2025):
	```
...
- [GitHub](https://github.com/vldgroup/graph-pes) (👨‍💻 5 · 🔀 13 · 📦 3 · 📋 17 - 17% open · ⏱️ 20.02.2026):
	...
	```
- [PyPi](https://pypi.org/project/graph-pes) (📥 4K / month):
	```
	pip install graph-pes
	```
</details>
<details><summary><b><a href="https://github.com/basf/mlipx">MLIPX - Machine-Learned Interatomic Potential eXploration</a></b> (🥈15 ·  ⭐ 97) - Machine-Learned Interatomic Potential eXploration (mlipx) is designed at BASF for evaluating machine-learned.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code>benchmarking</code> <a href="https://en.wikipedia.org/wiki/Visualization"><code>viz</code></a> <code>workflows</code></summary>
...
- [GitHub](https://github.com/basf/mlipx) (👨‍💻 5 · 🔀 7 · 📦 6 · 📋 18 - 33% open · ⏱️ 16.10.2025):
	...
	```
- [PyPi](https://pypi.org/project/mlipx) (📥 1.9K / month · ⏱️ 09.06.2025):
	```
	pip install mlipx
	```
</details>
...
<details><summary><b><a href="https://github.com/ACEsuit/mace-jax">MACE-Jax</a></b> (🥈13 ·  ⭐ 90) - Equivariant machine learning interatomic potentials in JAX. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/Teoroo-CMC/PiNN) (👨‍💻 7 · 🔀 39 · 📋 7 - 14% open · ⏱️ 06.03.2026):
	...
	```
- [Docker Hub](https://hub.docker.com/r/teoroo/pinn) (📥 700 · ⏱️ 06.03.2026):
	```
...
- [GitHub](https://github.com/ElliottKasoar/aiida-mlip) (👨‍💻 7 · 🔀 10 · ⏱️ 30.01.2026):
	...
	```
- [PyPi](https://pypi.org/project/aiida-mlip) (📥 240 / month · ⏱️ 17.11.2025):
	```
...
- [GitHub](https://github.com/ACEsuit/ACEfit.jl) (👨‍💻 9 · 🔀 8 · 📋 59 - 38% open · ⏱️ 19.03.2026):
...
- [GitHub](https://github.com/Yeonghun1675/ChatMOF) (👨‍💻 2 · 🔀 21 · 📦 3 · ⏱️ 15.05.2025):
	...
	```
- [PyPi](https://pypi.org/project/chatmof) (📥 320 / month · ⏱️ 01.07.2024):
	```
	pip install chatmof
	```
</details>
...
- [GitHub](https://github.com/usnistgov/atomgpt) (👨‍💻 7 · 🔀 10 · ⏱️ 21.08.2025):
	...
	```
- [PyPi](https://pypi.org/project/atomgpt) (📥 56 / month · 📦 1 · ⏱️ 22.03.2025):
	```
	pip install atomgpt
	```
</details>
...
- [GitHub](https://github.com/WMD-group/SMACT) (👨‍💻 48 · 🔀 29 · 📦 72 · ⏱️ 05.03.2026):
	...
	```
- [PyPi](https://pypi.org/project/smact) (📥 8.8K / month · 📦 14 · ⏱️ 03.03.2026):
	```
	pip install smact
	```
- [Conda](https://anaconda.org/conda-forge/smact) (📥 9.7K · ⏱️ 31.07.2025):
	```
...
- [PyPi](https://pypi.org/project/aalto-boss) (📥 660 / month · ⏱️ 28.11.2025):
	```
	pip install aalto-boss
	```
- [GitLab](https://gitlab.com/cest-group/boss) (🔀 13 · 📋 39 - 17% open · ⏱️ 28.11.2025):
...
- [GitHub](https://github.com/NVIDIA/cuEquivariance) (👨‍💻 7 · 🔀 27 · 📋 78 - 20% open · ⏱️ 16.03.2026):

	```
	git clone https://github.com/NVIDIA/cuEquivariance
	```
- [PyPi](https://pypi.org/project/cuequivariance) (📥 94K / month · 📦 10 · ⏱️ 16.03.2026):
	```
...
- [GitHub](https://github.com/ziatdinovmax/gpax) (👨‍💻 6 · 🔀 28 · 📦 6 · 📋 42 - 21% open · ⏱️ 04.07.2025):
...
- [GitHub](https://github.com/jax-md/jax-md) (👨‍💻 44 · 🔀 230 · 📦 82 · 📋 200 - 33% open · ⏱️ 23.01.2026):

	```
	git clone https://github.com/jax-md/jax-md
	```
- [PyPi](https://pypi.org/project/jax-md) (📥 13K / month · 📦 16 · ⏱️ 07.11.2025):
	```
	pip install jax-md
	```
</details>
...
- [GitHub](https://github.com/TorchSim/torch-sim) (👨‍💻 32 · 🔀 84 · 📋 150 - 16% open · ⏱️ 18.03.2026):

	```
	git clone https://github.com/Radical-AI/torch-sim
	```
- [PyPi](https://pypi.org/project/torch-sim-atomistic) (📥 170K / month · 📦 7 · ⏱️ 18.02.2026):
	```
...
- [GitHub](https://github.com/brucefan1983/GPUMD) (👨‍💻 57 · 🔀 170 · 📋 260 - 6% open · ⏱️ 19.03.2026):
...
- [GitHub](https://github.com/openmm/openmm-ml) (👨‍💻 8 · 🔀 33 · 📦 2 · 📋 68 - 33% open · ⏱️ 19.03.2026):
...
- [GitHub](https://github.com/cdk/cdk) (👨‍💻 170 · 🔀 180 · 📥 67K · 📋 330 - 2% open · ⏱️ 14.03.2026):
...
- [GitHub](https://github.com/SINGROUP/dscribe) (👨‍💻 18 · 🔀 96 · 📦 280 · 📋 110 - 12% open · ⏱️ 27.09.2025):
	...
	```
- [PyPi](https://pypi.org/project/dscribe) (📥 200K / month · 📦 63 · ⏱️ 27.09.2025):
	```
	pip install dscribe
	```
...
- [GitHub](https://github.com/PhasesResearchLab/pySIPFENN) (👨‍💻 5 · 🔀 5 · 📥 120 · 📦 7 · 📋 8 - 62% open · ⏱️ 20.01.2026):
	...
	```
- [PyPi](https://pypi.org/project/pysipfenn) (📥 130 / month · ⏱️ 20.01.2026):
	```
...
- [GitHub](https://github.com/metatensor/featomic) (👨‍💻 19 · 🔀 18 · 📥 840 · 📋 88 - 48% open · ⏱️ 18.03.2026):
...
- [GitHub](https://github.com/drcassar/glasspy) (👨‍💻 2 · 🔀 8 · 📦 7 · 📋 16 - 43% open · ⏱️ 17.03.2026):
	...
	```
- [PyPi](https://pypi.org/project/glasspy) (📥 650 / month · ⏱️ 13.03.2026):
	```
	pip install glasspy
	```
</details>
...
- [GitHub](https://github.com/rouyang2017/SISSO) (👨‍💻 3 · 🔀 93 · 📋 75 - 20% open · ⏱️ 26.01.2026):

	```
	git clone https://github.com/rouyang2017/SISSO
	```
</details>
<details><summary><b><a href="https://github.com/WMD-group/PDynA">PDynA</a></b> (🥈12 ·  ⭐ 50) - Python package to analyse the structural dynamics of perovskites. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <a href="https://en.wikipedia.org/wiki/Molecular_dynamics"><code>MD</code></a></summary>
...
<details><summary><b><a href="https://github.com/materialyzeai/matgl">MatGL (Materials Graph Library)</a></b> (🥇28 ·  ⭐ 520) - Graph deep learning library for materials. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code> <code>ML-IAP</code> <code>pretrained</code> <a href="https://en.wikipedia.org/wiki/Multifidelity_simulation"><code>multifidelity</code></a></summary>

- [GitHub](https://github.com/materialyzeai/matgl) (👨‍💻 25 · 🔀 110 · 📦 92 · 📋 160 - 2% open · ⏱️ 15.03.2026):

	```
	git clone https://github.com/materialsvirtuallab/matgl
	```
- [PyPi](https://pypi.org/project/matgl) (📥 29K / month · 📦 33 · ⏱️ 15.03.2026):
	```
	pip install matgl
	```
- [Docker Hub](https://hub.docker.com/r/materialsvirtuallab/matgl) (📥 240 · ⭐ 1 · ⏱️ 08.04.2025):
	```
	docker pull materialsvirtuallab/matgl
	```
</details>
<details><summary><b><a href="https://github.com/atomistic-machine-learning/schnetpack">SchNetPack</a></b> (🥇25 ·  ⭐ 910 · 📉) - SchNetPack - Deep Neural Networks for Atomistic Systems. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/atomistic-machine-learning/schnetpack) (👨‍💻 43 · 🔀 250 · 📋 280 - 1% open · ⏱️ 17.03.2026):

	```
	git clone https://github.com/atomistic-machine-learning/schnetpack
	```
- [PyPi](https://pypi.org/project/schnetpack) (📥 6K / month · 📦 4 · ⏱️ 19.12.2025):
	```
...
- [GitHub](https://github.com/ORNL/HydraGNN) (👨‍💻 18 · 🔀 38 · 📦 3 · 📋 56 - 30% open · ⏱️ 13.03.2026):
...
- [GitHub](https://github.com/lanl/hippynn) (👨‍💻 20 · 🔀 34 · 📦 4 · 📋 37 - 27% open · ⏱️ 04.03.2026):
...
- [GitHub](https://github.com/sparks-baird/CrabNet) (👨‍💻 6 · 🔀 6 · 📦 16 · 📋 19 - 84% open · ⏱️ 04.06.2025):
	...
	```
- [PyPi](https://pypi.org/project/crabnet) (📥 400 / month · 📦 2 · ⏱️ 10.01.2023):
	```
	pip install crabnet
	```
</details>
<details><summary><b><a href="https://github.com/learningmatter-mit/uvvisml">UVVisML</a></b> (🥈9 ·  ⭐ 35 · 💤) - Predict optical properties of molecules with machine learning. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <a href="https://en.wikipedia.org/wiki/Optical_properties"><code>optical-properties</code></a> <code>single-paper</code> <code>probabilistic</code></summary>

- [GitHub](https://github.com/learningmatter-mit/uvvisml) (🔀 10 · ⏱️ 30.07.2025):
...
- <b><a href="https://github.com/masashitsubaki/molecularGNN_smiles">molecularGNN_smiles</a></b> (🥈9 ·  ⭐ 340 · 💀) - The code of a graph neural network (GNN) for molecules, which is based on learning representations of r-radius.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code>
...
- <b><a href="https://github.com/learningmatter-mit/GLAMOUR">GLAMOUR</a></b> (🥉7 ·  ⭐ 24 · 💀) - Graph Learning over Macromolecule Representations. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code>single-paper</code>
...
- [GitHub](https://github.com/MDIL-SNU/SevenNet) (👨‍💻 20 · 🔀 51 · 📥 12K · 📋 88 - 18% open · ⏱️ 15.03.2026):

	```
	git clone https://github.com/MDIL-SNU/SevenNet
	```
- [PyPi](https://pypi.org/project/sevenn) (📥 200K / month · 📦 23 · ⏱️ 03.03.2026):
	```
	pip install sevenn
	```
</details>
...
- [GitHub](https://github.com/ACEsuit/mace-foundations) (👨‍💻 3 · 🔀 380 · 📥 340K · 📋 34 - 8% open · ⏱️ 19.11.2025):
...
- [GitHub](https://github.com/microsoft/mattersim) (👨‍💻 20 · 🔀 75 · 📥 36 · 📋 46 - 52% open · ⏱️ 18.03.2026):

	```
	git clone https://github.com/microsoft/mattersim
	```
- [PyPi](https://pypi.org/project/mattersim) (📥 210K / month · 📦 21 · ⏱️ 25.02.2026):
	```
	pip install mattersim
	```
</details>
<details><summary><b><a href="https://github.com/orbital-materials/orb-models">Orb Models</a></b> (🥉21 ·  ⭐ 550) - ORB forcefield models from Orbital Materials. <code><a href="https://github.com/orbital-materials/orb-models/blob/main/LICENSE">Custom</a></code> <code>ML-IAP</code> <code>pretrained</code></summary>

- [GitHub](https://github.com/orbital-materials/orb-models) (👨‍💻 16 · 🔀 77 · 📦 34 · 📋 75 - 4% open · ⏱️ 18.03.2026):

	```
	git clone https://github.com/orbital-materials/orb-models
	```
- [PyPi](https://pypi.org/project/orb-models) (📥 7.5K / month · 📦 36 · ⏱️ 18.03.2026):
	```
...
- [GitHub](https://github.com/sissa-data-science/DADApy) (👨‍💻 21 · 🔀 23 · 📋 42 - 28% open · ⏱️ 12.02.2026):
	...
	```
- [PyPi](https://pypi.org/project/dadapy) (📥 700 / month · ⏱️ 11.04.2025):
	```
	pip install dadapy
	```
</details>
...
- [GitHub](https://github.com/materialsproject/crystaltoolkit) (👨‍💻 38 · 🔀 66 · 📦 43 · 📋 150 - 45% open · ⏱️ 13.03.2026):

	```
	git clone https://github.com/materialsproject/crystaltoolkit
	```
- [PyPi](https://pypi.org/project/crystal-toolkit) (📥 4.5K / month · 📦 12 · ⏱️ 05.03.2026):
	```
...
- [GitHub](https://github.com/janosh/pymatviz) (👨‍💻 14 · 🔀 38 · 📥 3.5K · 📦 31 · 📋 65 - 1% open · ⏱️ 09.03.2026):
...
- [GitHub](https://github.com/lab-cosmo/chemiscope) (👨‍💻 27 · 🔀 43 · 📥 650 · 📦 6 · 📋 170 - 8% open · ⏱️ 14.03.2026):
...
- [GitHub](https://github.com/janosh/matterviz) (👨‍💻 6 · 🔀 30 · 📥 3.4K · 📦 4 · 📋 43 - 4% open · ⏱️ 10.03.2026):
...
- [GitHub](https://github.com/zincware/ZnDraw) (👨‍💻 13 · 🔀 5 · 📦 16 · 📋 370 - 19% open · ⏱️ 19.03.2026):

	```
	git clone https://github.com/zincware/ZnDraw
	```
- [PyPi](https://pypi.org/project/zndraw) (📥 3.9K / month · 📦 5 · ⏱️ 19.03.2026):
	```
	pip install zndraw
	```
</details>
